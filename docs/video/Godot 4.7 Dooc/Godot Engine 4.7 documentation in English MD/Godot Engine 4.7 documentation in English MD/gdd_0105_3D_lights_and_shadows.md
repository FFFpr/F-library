...
There are three types of light nodes: DirectionalLight3D,
OmniLight3D and SpotLight3D. Let's take a look at the common
parameters for lights:

![../../_images/light_params.png](../../_images/light_params.png)
...
an omni light, a spot light, a decal or a
reflection probe. This limit can be increased by adjusting
...
Max Renderable Elements
and/or Max Lights per Object
...
consider using baked lightmaps with lights' bake
...
![../../_images/lights_and_shadows_blur.png](../../_images/lights_and_shadows_blur.png)
...
![../../_images/lights_and_shadows_acne.png](../../_images/lights_and_shadows_acne.png)
...
![../../_images/lights_and_shadows_peter_panning.png](../../_images/lights_and_shadows_peter_panning.png)
...
![../../_images/light_directional.png](../../_images/light_directional.png)
...
![../../_images/lights_and_shadows_pssm_explained.png](../../_images/lights_and_shadows_pssm_explained.png)

With this, shadows become more detailed:

![../../_images/lights_and_shadows_directional_mode.png](../../_images/lights_and_shadows_directional_mode.png)

To control PSSM, a number of parameters are exposed:

![../../_images/lights_and_shadows_directional_shadow_params.png](../../_images/lights_and_shadows_directional_shadow_params.png)
...
![../../_images/blend_splits.png](../../_images/blend_splits.png)
...
![../../_images/light_omni.png](../../_images/light_omni.png)
...
![../../_images/light_omni_params.png](../../_images/light_omni_params.png)

These two parameters allow tweaking how this works visually in order to find aesthetically pleasing results.

![../../_images/light_attenuation.png](../../_images/light_attenuation.png)
...
![../../_images/lights_and_shadows_pcss.png](../../_images/lights_and_shadows_pcss.png)
...
![../../_images/lights_and_shadows_dual_parabolid_vs_cubemap.png](../../_images/lights_and_shadows_dual_parabolid_vs_cubemap.png)
...
![../../_images/lights_and_shadows_omni_projector_example.png](../../_images/lights_and_shadows_omni_projector_example.png)

![../../_images/lights_and_shadows_omni_projector.png](../../_images/lights_and_shadows_omni_projector.png)

Tip

If you've acquired omni projectors in the form of cubemap images, you can use
this web-based conversion tool [https://danilw.github.io/GLSL-howto/cubemap_to_panorama_js/cubemap_to_panorama.html]
...
![../../_images/lights_and_shadows_spot_projector_example.png](../../_images/lights_and_shadows_spot_projector_example.png)

![../../_images/lights_and_shadows_spot_projector.png](../../_images/lights_and_shadows_spot_projector.png)
...
Godot provides the AreaLight3D node for this purpose, which emits
light from a rectangular area. The node only emits light and has no other visual
representation in the scene. The screenshots below use a Sprite3D
...
![../../_images/lights_and_shadows_area_example.png](../../_images/lights_and_shadows_area_example.png)
...
![../../_images/lights_and_shadows_area_texture.png](../../_images/lights_and_shadows_area_texture.png)
...
![../../_images/lights_and_shadows_shadow_quadrants.png](../../_images/lights_and_shadows_shadow_quadrants.png)

Each quadrant can be subdivided to allocate any number of shadow maps; the following is the default subdivision:

![../../_images/lights_and_shadows_shadow_quadrants2.png](../../_images/lights_and_shadows_shadow_quadrants2.png)
...
shadow atlas quadrants to contain
...
Temporal antialiasing (TAA), AMD FidelityFX Super Resolution 2.2 (FSR2),
Fast approximate antialiasing (FXAA), or increase the shadow filter quality to
...
![../../_images/lights_and_shadows_filter_quality.png](../../_images/lights_and_shadows_filter_quality.png)
...
- Enabled: Controls whether distance fade (a form of LOD)
