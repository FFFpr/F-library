...
In a normal scenario, you would use a MeshInstance3D
...
MultiMeshInstance3D is one of the possible
...
In our example, we would use a Node3D node as the root node of
the scene. Your scene tree would look like this:

![../../_images/multimesh_scene_tree.png](../../_images/multimesh_scene_tree.png)
...
![../../_images/multimesh_toolbar.png](../../_images/multimesh_toolbar.png)

![../../_images/multimesh_settings.png](../../_images/multimesh_settings.png)
...
![../../_images/multimesh_result.png](../../_images/multimesh_result.png)
