...
how to get started with C++ (godot-cpp), take a look at the GDExtension C++ Example.
...
android_aar_plugin | Boolean | The GDExtension is part of a v2 Android plugin. During export this flag
...
the stock editor icons. Read the guide for creating icons
