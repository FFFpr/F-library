...
texture blit shader. Even when the user does
...
To do so, you can instantiate and pass in a new BlitMaterial
in the script.
...
DrawableTextures also have a blit_rect_multi()
...
Next, you'll need to create a TextureRect node, which is going to
...
modulate parameter. We will use this plain white circle texture,
...
you could connect a ColorPickerButton node to the script to store
