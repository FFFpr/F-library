...
![../../_images/unique_name_scene_instance_example.png](../../_images/unique_name_scene_instance_example.png)
...
A Group allows locating a node (or a group of many nodes)
from any other node, no matter what scene the two nodes are located in.

A Singleton (Autoload) is an always loaded node
