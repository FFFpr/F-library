...
the rendering pipeline when rendering the contents of a Viewport.

It can be configured on a WorldEnvironment
node where it applies to all Viewports, or it can be configured on
a Camera3D and apply only to
the Viewport using that camera.

The Compositor resource is used to configure
the compositor. To get started, create a new compositor on the appropriate node:

![../../_images/new_compositor.png](../../_images/new_compositor.png)
...
please check Using compute shaders.
...
Note the use of a Mutex in our code.
...
Note the use of our UniformSetCacheRD cache
...
![../../_images/add_compositor_effect.png](../../_images/add_compositor_effect.png)
...
![../../_images/post_process_shader.png](../../_images/post_process_shader.png)
