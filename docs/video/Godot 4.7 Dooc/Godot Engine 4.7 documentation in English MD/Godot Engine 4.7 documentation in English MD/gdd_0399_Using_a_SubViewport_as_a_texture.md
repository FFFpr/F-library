...
This tutorial will introduce you to using the SubViewport as a
...
![../../_images/planet_example.png](../../_images/planet_example.png)
...
a Camera3D, a light source, a
MeshInstance3D with a Primitive Mesh,
and applying a StandardMaterial3D to the mesh. The focus will be on using
the SubViewport to dynamically create textures that can be applied to the mesh.
...
![../../_images/viewport_texture_node_tree.png](../../_images/viewport_texture_node_tree.png)
...
Next disable 3D. We will be using a ColorRect to render the surface, so
we don't need 3D either.

![../../_images/planet_new_viewport.png](../../_images/planet_new_viewport.png)
...
![../../_images/planet_new_colorrect.png](../../_images/planet_new_colorrect.png)
...
![../../_images/planet_gradient.png](../../_images/planet_gradient.png)

Now we have the basics of a SubViewport that we render to and we have a unique image that we can
apply to the sphere.

## Applying the texture

Now go into the MeshInstance3D and add a StandardMaterial3D
...
![../../_images/planet_new_viewport_texture.png](../../_images/planet_new_viewport_texture.png)
...
![../../_images/planet_pick_viewport_texture.png](../../_images/planet_pick_viewport_texture.png)

Your sphere should now be colored in with the colors we rendered to the Viewport.

![../../_images/planet_seam.png](../../_images/planet_seam.png)
...
![../../_images/planet_sincos.png](../../_images/planet_sincos.png)
...
StandardMaterial3D. It uses a projection technique called equirectangular
...
![../../_images/planet_normals.png](../../_images/planet_normals.png)
...
![../../_images/planet_noise.png](../../_images/planet_noise.png)
...
![../../_images/planet_noise_color.png](../../_images/planet_noise_color.png)
...
![../../_images/planet_noise_smooth.png](../../_images/planet_noise_smooth.png)
...
![../../_images/planet_noise_fbm.png](../../_images/planet_noise_fbm.png)
...
![../../_images/planet_ocean.png](../../_images/planet_ocean.png)
...
Now the planet should look like it is reflecting light on the ocean but not the land. move around the OmniLight3D
in the scene so you can see the effect of the reflections on the ocean.

![../../_images/planet_ocean_reflect.png](../../_images/planet_ocean_reflect.png)
