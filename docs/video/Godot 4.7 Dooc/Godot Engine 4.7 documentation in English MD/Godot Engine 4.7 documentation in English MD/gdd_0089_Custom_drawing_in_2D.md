...
The _draw function is only called
...
draw_set_transform or
draw_set_transform_matrix.

When using draw_line, you should
...
![../../_images/draw_line.png](../../_images/draw_line.png)
...
![../../_images/draw_rect.png](../../_images/draw_rect.png)
...
![../../_images/draw_antialiasing_options.png](../../_images/draw_antialiasing_options.png)
...
To do this, you can use the tool annotation
on both GDScript and C#. See
the example below and
Running code in the editor for more information.
...
Polygon2D), we will use in this case exclusively lower
...
![../../_images/draw_godot_logo_polygon.png](../../_images/draw_godot_logo_polygon.png)
...
![../../_images/draw_godot_logo_polyline.png](../../_images/draw_godot_logo_polyline.png)
...
code or a predefined color name. Check the class Color for other
...
draw_circle method. The first
parameter is a Vector2 with the coordinates of its center, the second is
...
![../../_images/draw_godot_logo_circle.png](../../_images/draw_godot_logo_circle.png)
...
![../../_images/draw_godot_logo_line.png](../../_images/draw_godot_logo_line.png)
...
the draw_multiline method.

### Drawing text

While using the Label Node is the most common way to add
...
We will use the draw_string method
to do it, like this:
...
![../../_images/draw_godot_logo_text.png](../../_images/draw_godot_logo_text.png)
...
@tool annotation to request the custom drawing
...
![tutorials/2d/img/draw_godot_rotation.png](tutorials/2d/img/draw_godot_rotation.png)
...
changing the width of its mouth line follow a sinusoidal (sin) curve:
...
![tutorials/2d/img/draw_godot_mouth_animation.png](tutorials/2d/img/draw_godot_mouth_animation.png)
...
sprites or
AnimatedSprites loading SVG resources (which are
...
![../../_images/draw_line_between_2_points.png](../../_images/draw_line_between_2_points.png)
...
![../../_images/draw_dynamic_exported_properties.png](../../_images/draw_dynamic_exported_properties.png)

To draw the arc, we can use the method
draw_arc. There are many
...
![../../_images/draw_arc_between_2_points.png](../../_images/draw_arc_between_2_points.png)
