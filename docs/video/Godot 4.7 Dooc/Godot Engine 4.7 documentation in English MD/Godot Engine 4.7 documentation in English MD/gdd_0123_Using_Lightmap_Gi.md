...
lighting to a scene. Unlike the VoxelGI and
SDFGI approaches, baked lightmaps work fine on low-end PCs
...
using Reflection probes together with it on interiors (or using a Sky
...
See Which global illumination technique should I use?
for a comparison of GI techniques available in Godot 4.

## Visual comparison

![LightmapGI disabled.](../../../_images/gi_none.png)

LightmapGI disabled.

![LightmapGI enabled (with indirect light baked only).](../../../_images/gi_lightmap_gi_indirect_only.png)
...
![LightmapGI enabled (with direct and indirect light baked).](../../../_images/gi_lightmap_gi_direct_and_indirect.png)
...
![../../../_images/lightmap_gi_comparison.png](../../../_images/lightmap_gi_comparison.png)
...
![../../../_images/lightmap_gi_import.png](../../../_images/lightmap_gi_import.png)

The Meshes > Light Baking option must be set to Static Lightmaps (VoxelGI/SDFGI/LightmapGI):

![../../../_images/lightmap_gi_mesh_import_meshes.png](../../../_images/lightmap_gi_mesh_import_meshes.png)
...
![../../../_images/lightmap_gi_mesh_menu.png](../../../_images/lightmap_gi_mesh_menu.png)
...
![../../../_images/lightmap_gi_blender.png](../../../_images/lightmap_gi_blender.png)

Then import the 3D scene normally. Remember you will need to set the texture
size on the mesh after import.

![../../../_images/lightmap_gi_lmsize.png](../../../_images/lightmap_gi_lmsize.png)
...
convert a CSG node and its children to a MeshInstance3D.
...
![../../../_images/lightmap_gi_uvchannel.png](../../../_images/lightmap_gi_uvchannel.png)
...
![../../../_images/lightmap_gi_scene.png](../../../_images/lightmap_gi_scene.png)
...
![../../../_images/lightmap_gi_use.png](../../../_images/lightmap_gi_use.png)
...
![../../../_images/lightmap_gi_bake_mode.png](../../../_images/lightmap_gi_bake_mode.png)
...
![../../../_images/lightmap_gi_omnilight_size.png](../../../_images/lightmap_gi_omnilight_size.png)
...
![../../../_images/lightmap_gi_bake.png](../../../_images/lightmap_gi_bake.png)
...
from the camera. See the section on shadowmasking
for further details.
...
Denoising for more information.
...
the denoising method is JNLM
(OIDN does not have a denoiser strength setting).
...
![Comparison between shadowmask modes](../../../_images/lightmap_gi_shadowmask.png)
...
![Comparison between denoising disabled and enabled](../../../_images/lightmap_gi_denoiser_comparison.png)
...
![Comparison between JNLM denoiser strength values](../../../_images/lightmap_gi_denoiser_jnlm_strength.png)
...
![Comparison between JNLM and OIDN denoisers](../../../_images/lightmap_gi_denoiser_jnlm_vs_oidn.png)
...
automatically, you can add light probes manually by adding LightmapProbe
