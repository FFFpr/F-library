...
scene system. Using nodes and resources simplifies
...
- It is not possible to use multiple threads
to control them.
...
The key to using servers is understanding Resource ID (RID)
...
inherits Resource can be directly casted to an RID. Not
...
Resources are reference-counted (see RefCounted),
...
- For 2D, the World2D resource (obtainable in the Viewport
...
- For 3D, the World3D resource (obtainable in the Viewport
and Node3D nodes)
...
- The VisualInstance3D class, allows getting the scenario instance and
instance base via the VisualInstance3D.get_instance()
and VisualInstance3D.get_base() respectively.
...
public partial class MyNode2D : Node2D
{
    ...
    public override void _Ready()
    {
        ...
        // Draw a texture on it.
        // Remember to keep this reference.
        _texture = ResourceLoader.Load("res://my_texture.png");
        // Add it, centered.
...
public partial class MyNode3D : Node3D
{
    ...
    public override void _Ready()
    {
        ...
        // Add a mesh to it.
        // Remember to keep this reference.
        _mesh = ResourceLoader.Load("res://my_mesh.obj");
...
This creates a RigidBody2D using the PhysicsServer2D API,
...
identical (using RigidBody3D and PhysicsServer3D
respectively).

## Getting data from the servers

Try to never request any information from RenderingServer,
PhysicsServer2D, or PhysicsServer3D by calling
