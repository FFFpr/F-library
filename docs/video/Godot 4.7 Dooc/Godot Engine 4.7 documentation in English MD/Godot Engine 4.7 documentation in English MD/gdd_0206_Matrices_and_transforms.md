...
and understand the Vector math tutorial, as this tutorial
...
![../../_images/identity.png](../../_images/identity.png)
...
![../../_images/identity-godot.png](../../_images/identity-godot.png)
...
![../../_images/scale.png](../../_images/scale.png)
...
![../../_images/rotate1.png](../../_images/rotate1.png)
...
![../../_images/rotate2.png](../../_images/rotate2.png)
...
![../../_images/rotate3.png](../../_images/rotate3.png)
...
it from Transform3D (which is composed of one
...
![../../_images/identity-origin.png](../../_images/identity-origin.png)

If we want to move the object to a position of (1, 2), we need
to set its origin vector to (1, 2):

![../../_images/translate.png](../../_images/translate.png)
...
![../../_images/putting-all-together.png](../../_images/putting-all-together.png)
...
![../../_images/identity-grid.png](../../_images/identity-grid.png)
...
![../../_images/shear.png](../../_images/shear.png)
...
transforms by having multiple Node2D or Node3D
...
Transform3D to manually calculate transforms of nodes.
...
![../../_images/apply.png](../../_images/apply.png)
...
the Basis separately from the Transform3D,
...
![../../_images/3d-identity.png](../../_images/3d-identity.png)
