...
Along with Mesh level of detail (LOD) and Occlusion culling,
...
Mesh level of detail (LOD) instead.
...
for artist-controlled HLOD, but also
...
to use different node types as part of a LOD system.
...
The benefit of HLOD over a traditional
LOD system is its hierarchical nature. A single larger
...
HLOD. It allows automatically hiding
...
This is done to minimize visible pop-in. Depending on your HLOD setup, you may want to try both the Self and
Dependencies fade modes.
