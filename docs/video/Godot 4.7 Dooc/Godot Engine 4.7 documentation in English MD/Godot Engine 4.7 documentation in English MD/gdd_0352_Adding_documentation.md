...
XML files (one per class) to document the exposed constructors, properties, methods,
...
![../../../_images/gdextension_docs_generation.png](../../../_images/gdextension_docs_generation.png)
