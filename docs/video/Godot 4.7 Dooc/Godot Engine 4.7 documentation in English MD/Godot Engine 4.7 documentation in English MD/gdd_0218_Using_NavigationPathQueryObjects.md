...
![Path post-processing differences depending on navigation mesh polygon layout](../../_images/path_postprocess_diff.png)
...
![Path point difference with or without path simplification](../../_images/path_simplification_diff.png)
...
![Clipping returned paths to specific distances](../../_images/path_clip_and_limits.gif)
