...
Importing translations tutorial. If you haven't read the Importing
...
![../../_images/localization_dialog.png](../../_images/localization_dialog.png)
...
![../../_images/localization_remaps.png](../../_images/localization_remaps.png)
...
A locale is commonly a combination of a language with a
...
In code, the Object.tr() function can be used.
...
```
// "Close", as in an action (to close something).
GetNode("Button").Text = Tr("Close", "Actions");
// "Close", as in a distance (opposite of "far").
GetNode("Distance").Text = Tr("Close", "Distance");
```
...
```
int numApples = 5;
GetNode("Label").Text = string.Format(TrN("There is {0} apple", "There are {0} apples", numApples), numApples);
```
...
```
int numJobs = 1;
GetNode("Label").Text = string.Format(TrN("{0} job", "{0} jobs", numJobs, "Task Manager"), numJobs);
```
...
the original, you can enable pseudolocalization
...
whether a font can support CJK or
...
![../../_images/ui_mirror.png](../../_images/ui_mirror.png)
...
![../../_images/bidi_override.png](../../_images/bidi_override.png)
...
and TextServer.parse_number(string, language)
to convert it back.
...
![../../_images/locale_test.png](../../_images/locale_test.png)
...
![../../_images/locale_editor_preview.png](../../_images/locale_editor_preview.png)
...
![../../_images/localized_name.png](../../_images/localized_name.png)
