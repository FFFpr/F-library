...
One of the biggest things to consider in Object-Oriented Programming (OOP) [https://en.wikipedia.org/wiki/Object-oriented_programming] is maintaining
...
// Child
call(method_name); // Call parent-specified method (which child must own).
3. Initialize a Callable property. Safer than a method
...
```
// Parent
get_node("Left")->target = get_node("Right/Receiver");
...
A Graphical User Interface (GUI) [https://en.wikipedia.org/wiki/Graphical_user_interface]
...
Changing scenes manually gives you full
...
SceneTree.change_scene_to_file() method
