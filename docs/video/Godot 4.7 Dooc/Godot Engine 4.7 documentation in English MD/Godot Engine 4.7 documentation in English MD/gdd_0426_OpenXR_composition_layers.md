...
The solution then is to render the UI to a SubViewport
and display the result of this using a ViewportTexture on a 3D mesh.
The QuadMesh is a suitable option for this.
...
![../../_images/openxr_composition_layer_subviewport.png](../../_images/openxr_composition_layer_subviewport.png)
...
![../../_images/openxr_composition_layer_quad.png](../../_images/openxr_composition_layer_quad.png)
...
we prepare an InputEventMouseMotion object
...
an InputEventMouseButton object
...
![../../_images/openxr_composition_layer_hole_punch.png](../../_images/openxr_composition_layer_hole_punch.png)
