...
![../../_images/inputs_inputmap.png](../../_images/inputs_inputmap.png)
...
See @GlobalScope_Key for a list of keycode
constants.
...
Capturing mouse buttons is very similar to handling key events. @GlobalScope_MouseButton
...
Here's an example using mouse events to drag-and-drop a Sprite2D
node:
