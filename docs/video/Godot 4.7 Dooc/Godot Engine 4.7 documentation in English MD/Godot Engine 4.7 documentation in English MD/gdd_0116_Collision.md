...
![Particle collisions](tutorials/3d/particles/img/particle_collision.png)
...
There are four of them: GPUParticlesCollisionBox3D, GPUParticlesCollisionSphere3D,
GPUParticlesCollisionSDF3D, and GPUParticlesCollisionHeightField3D.

## Common properties

![Common particle collision properties](../../../_images/particle_collision_common.png)
...
on each system's visibility layers. A particle system collides with a
collision node only if at least one of the system's visibility layers is enabled in the
collider's cull mask.

## Box collision

![Particle collision box](../../../_images/particle_collision_box_entry.png)
...
![Box collision with particle systems](tutorials/3d/particles/img/particle_collision_box.png)

Two particle systems collide with a box collision node

## Sphere collision

![Particle collision sphere](../../../_images/particle_collision_sphere_entry.png)
...
![Sphere collision with particle systems](tutorials/3d/particles/img/particle_collision_sphere.png)

Two particle systems collide with a sphere collision node

## Height field collision

![Particle collision height field](../../../_images/particle_collision_height.png)
...
![Height field resolutions](tutorials/3d/particles/img/particle_heightfield_res.png)
...
![Particle collision SDF](../../../_images/particle_collision_sdf_entry.png)
...
![SDF particle collision](tutorials/3d/particles/img/particle_collision_sdf.png)
...
![Resolution comparison](../../../_images/particle_collision_sdf_res.png)
