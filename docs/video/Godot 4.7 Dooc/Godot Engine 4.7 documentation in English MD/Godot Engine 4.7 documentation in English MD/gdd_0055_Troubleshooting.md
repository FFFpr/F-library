...
See Using the Web editor for caveats specific to the Web version
of the Godot editor.
...
![Correct appearance (left), oversharpened appearance due to graphics driver sharpening (right)](../_images/troubleshooting_graphics_driver_sharpening.png)
...
FXAA being forced on all Vulkan or
...
On Windows, this can also be due to case sensitivity issues. If you reference a resource
...
crashes. See the Project Manager page for more
information.
