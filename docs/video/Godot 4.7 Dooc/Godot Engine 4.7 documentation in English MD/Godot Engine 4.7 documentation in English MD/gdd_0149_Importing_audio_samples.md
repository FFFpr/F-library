...
type. The above figures use CBR encoding for
simplicity, but most Ogg Vorbis and MP3 files you can find online are encoded
with VBR encoding which is more efficient.
...
![Import options in the Import dock after selecting a WAV file in the FileSystem dock](../../_images/importing_audio_samples_import_options_wav.png)
...
![Import options in the Import dock after selecting an MP3 file in the FileSystem dock](../../_images/importing_audio_samples_import_options_mp3.png)
...
AudioStreamPlayer2D or AudioStreamPlayer3D nodes. See Audio streams
...
These silences are inserted by DAWs when
...
![Advanced dialog when double-clicking an Ogg Vorbis or MP3 file in the FileSystem dock](../../_images/importing_audio_samples_advanced_import_settings.png)
...
in addition to the BPM, beat count and bar beats.
...
Godot has an extensive bus system with built-in effects.
...
![../../_images/reverb.png](../../_images/reverb.png)
