...
At the core sits the XRServer which acts as a central interface to the XR system that allows users to discover interfaces and interact with the components of the XR system.
...
up correctly. Check the Enabled
...
but for more information on what's here see OpenXR Settings.
...
![../../_images/xr_shaders.png](../../_images/xr_shaders.png)
...
![../../_images/xr_basic_scene.png](../../_images/xr_basic_scene.png)
...
![../../_images/xr_left_hand.png](../../_images/xr_left_hand.png)

And the right hand:

![../../_images/xr_right_hand.png](../../_images/xr_right_hand.png)
...
If you run your project at this point in time, everything will work but you will be in a dark world. So to finish off our starting point add a DirectionalLight3D and a WorldEnvironment node to your scene.
