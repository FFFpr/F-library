...
objects in Godot, while Spatial shaders are used
to draw all 3D objects.

In order to use a shader it must be attached inside a Material which must be attached to an object. Materials are a type of
...
property. This includes all GUI elements, Sprite2Ds, TileMapLayers, MeshInstance2Ds etc. They also have an option to inherit their parent's
material. This can be useful if you have a large number of nodes that you want
to use the same material.

To begin, create a Sprite2D node. You can use any CanvasItem,
...
![../../../_images/blue-box.png](../../../_images/blue-box.png)
...
![../../../_images/iconuv.png](../../../_images/iconuv.png)
...
![../../../_images/blue-tex.png](../../../_images/blue-tex.png)
