...
in doubt, refer to the Making plugins page. This also
...
The _get_visible_name() method is
...
In our case it's a StandardMaterial3D, which can be applied to 3D
objects.
...
![../../../_images/import_plugin_options.png](../../../_images/import_plugin_options.png)
...
resources, is covered by the _import()
...
This part makes a new StandardMaterial3D that is the
...
![../../../_images/import_plugin_trying.png](../../../_images/import_plugin_trying.png)
