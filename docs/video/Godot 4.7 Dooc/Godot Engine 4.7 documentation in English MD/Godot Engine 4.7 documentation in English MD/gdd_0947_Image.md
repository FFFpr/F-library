...
Ericsson Texture Compression format 2 [https://en.wikipedia.org/wiki/Ericsson_Texture_Compression#ETC2_and_EAC] (RGBA8variant), which compresses RGBA8888 data with full alpha support.
