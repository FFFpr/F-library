...
![../../../_images/importing_3d_scenes_advanced_import_settings_button.png](../../../_images/importing_3d_scenes_advanced_import_settings_button.png)
...
![Advanced Import Settings dialog (Scene tab)](../../../_images/importing_3d_scenes_advanced_import_settings_scene.png)

Advanced Import Settings dialog (Scene tab).
Credit: Modern Arm Chair 01 - Poly Haven [https://polyhaven.com/a/modern_arm_chair_01]
...
![Selecting a node in the Advanced Import Settings dialog (Scene tab)](../../../_images/importing_3d_scenes_advanced_import_settings_node.png)
...
node for navigation. Mesh + NavMesh
...
node for occlusion culling using the mesh's
...
![Advanced Import Settings dialog (Meshes tab)](../../../_images/importing_3d_scenes_advanced_import_settings_meshes.png)

Advanced Import Settings dialog (Meshes tab)

The options are as follows:

- Save to File: Saves the Mesh resource to an external file
...
nodes, such as MeshInstance3D, MultiMeshInstance3D,
GPUParticles3D or CPUParticles3D.
...
Using the Import dock. Default will use the
...
![Advanced Import Settings dialog (Materials tab)](../../../_images/importing_3d_scenes_advanced_import_settings_materials.png)
...
![Extracting all built-in materials to external resources in the Advanced Import Settings dialog](../../../_images/importing_3d_scenes_advanced_import_settings_extract_materials.png)
...
![Confirming material extraction in the Advanced Import Settings subdialog](../../../_images/importing_3d_scenes_advanced_import_settings_extract_materials_confirm.png)
...
Several extra options are available for the generated AnimationPlayer
