...
![../../_images/add_material.png](../../_images/add_material.png)
...
![../../_images/spatial_material1.png](../../_images/spatial_material1.png)
...
![../../_images/spatial_material12.png](../../_images/spatial_material12.png)
...
techniques such as FXAA and TAA, this is not always
...
![../../_images/spatial_material8.png](../../_images/spatial_material8.png)
...
![../../_images/material_depth_draw.png](../../_images/material_depth_draw.png)
...
![../../_images/spatial_material3.png](../../_images/spatial_material3.png)
...
![../../_images/material_depth_test.png](../../_images/material_depth_test.png)
...
![Three spheres showing the Per-Pixel, Per-Vertex, and Unshaded modes.](../../_images/standard_material_shading_modes.png)
...
![Two cubes with a brick texture, one shaded and one unshaded.](../../_images/standard_material_shading_modes_textured.png)
...
![../../_images/spatial_material6.png](../../_images/spatial_material6.png)
...
![../../_images/spatial_material7.png](../../_images/spatial_material7.png)
...
![../../_images/spatial_material4.png](../../_images/spatial_material4.png)
...
![../../_images/spatial_material13.png](../../_images/spatial_material13.png)
...
![../../_images/spatial_material14.png](../../_images/spatial_material14.png)

## Emission

Emission specifies how much light is emitted by the material (keep in mind this
does not include light surrounding geometry unless VoxelGI
or SDFGI are used). This value is added to the resulting
final image and is not affected by other lighting in the scene.

![../../_images/spatial_material15.png](../../_images/spatial_material15.png)
...
![../../_images/spatial_material16.png](../../_images/spatial_material16.png)
...
![../../_images/spatial_material_bentnormals.png](../../_images/spatial_material_bentnormals.png)
...
![../../_images/spatial_material17.png](../../_images/spatial_material17.png)
...
![../../_images/clearcoat_comparison.png](../../_images/clearcoat_comparison.png)
...
![../../_images/spatial_material18.png](../../_images/spatial_material18.png)
...
![../../_images/spatial_material19.png](../../_images/spatial_material19.png)
...
for physics collision (such as terrain), see HeightMapShape3D. It
...
![../../_images/spatial_material20.png](../../_images/spatial_material20.png)
...
![../../_images/spatial_material21.png](../../_images/spatial_material21.png)
...
![../../_images/spatial_material22.png](../../_images/spatial_material22.png)
...
![../../_images/spatial_material23.png](../../_images/spatial_material23.png)
...
![../../_images/spatial_material24.png](../../_images/spatial_material24.png)
...
![../../_images/spatial_material25.png](../../_images/spatial_material25.png)
...
The filtering method for the textures used by the material. See this page
for a full list of options and their description.

### Repeat

if the textures used by the material repeat, and how they repeat. See this page
for a full list of options and their description.
...
specifying flipbook animation.

![../../_images/spatial_material9.png](../../_images/spatial_material9.png)
...
![../../_images/spatial_material10.png](../../_images/spatial_material10.png)
...
![../../_images/spatial_material11.png](../../_images/spatial_material11.png)
...
using the Outline stencil mode.
...
![../../_images/spatial_material_proxfade.gif](../../_images/spatial_material_proxfade.gif)
...
![../../_images/standart_material_distance_fade_pixel_alpha_mode.png](../../_images/standart_material_distance_fade_pixel_alpha_mode.png)

Pixel Dither mode: What this does is sort of approximate the transparency
by only having a fraction of the pixels rendered.

![../../_images/standart_material_distance_fade_pixel_dither_mode.png](../../_images/standart_material_distance_fade_pixel_dither_mode.png)

Object Dither mode: Like the previous mode, but the calculated transparency
is the same across the entire object's surface.

![../../_images/standart_material_distance_fade_object_dither_mode.png](../../_images/standart_material_distance_fade_object_dither_mode.png)
...
![../../_images/material_stencil.png](../../_images/material_stencil.png)
...
Like with the Grow property, for the
...
Objects are sorted by an opaque/transparent queue, then render_priority,
...
Setting next_pass on a material
...
![../../_images/next_pass.png](../../_images/next_pass.png)

Depth will test equal between both materials unless the grow setting or other vertex transformations are used.
Multiple transparent passes should use render_priority to ensure correct ordering.
