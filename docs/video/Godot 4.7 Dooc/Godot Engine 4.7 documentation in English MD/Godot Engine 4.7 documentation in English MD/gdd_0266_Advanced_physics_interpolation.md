...
Node (or branch of the SceneTree), and
have the finer control of performing interpolation manually.

This is possible using the Node.physics_interpolation_mode
...
![../../../_images/physics_interpolation_mode.png](../../../_images/physics_interpolation_mode.png)
...
In many cases, a Camera3D can use automatic interpolation
...
![../../../_images/fti_camera_worldspace.png](../../../_images/fti_camera_worldspace.png)

1. Call Node3D.top_level and set this to true, which will make the Camera ignore the transform of its parent.
