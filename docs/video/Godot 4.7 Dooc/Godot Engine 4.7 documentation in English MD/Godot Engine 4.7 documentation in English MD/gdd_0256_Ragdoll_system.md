...
![Creating a physical skeleton in the editor](../../_images/ragdoll_system_create_physical_skeleton.png)
...
![Scene tree of the player scene after creating a physical skeleton](../../_images/ragdoll_system_skeleton_scene_tree.png)
...
![Adjusting joints in the inspector after selecting a PhysicalBone3D node](../../_images/ragdoll_system_adjust_joints_inspector.png)
...
To do so, click View > Gizmos > Skeleton3D at the top of the 3D editor
...
- Change the debug draw mode using the Perspective button
in the top-left corner of the 3D editor viewport. The Display Wireframe
and Display Overdraw options are particularly useful when adjusting
collision shapes, as they allow you to see through the original mesh.
- Use the orthographic camera by clicking the X/Y/Z
...
![Adjusting collision shapes in the 3D editor](../../_images/ragdoll_system_adjust_collision_shapes.png)

Adjusting collision shapes in the 3D editor

This is the final result:

![Result after adjusting joints and collision shapes (player mesh is hidden for visibility)](../../_images/ragdoll_system_result.png)
...
![Layers and masks must be adjusted to these values in the inspector for each node](../../_images/ragdoll_system_collision_layers_masks.png)
...
using the physical_bones_add_collision_exception()
and physical_bones_remove_collision_exception()
methods. This can be used to prevent collisions with a specific object
without relying on layers and masks.

See also

For more information, see Collision layers and masks.
