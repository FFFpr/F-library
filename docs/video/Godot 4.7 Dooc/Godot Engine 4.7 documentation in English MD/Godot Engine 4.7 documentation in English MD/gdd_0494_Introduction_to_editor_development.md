...
To create editor plugins in GDScript, see Making plugins instead.

See also

If you are new to Godot, we recommended you to read
Godot's design philosophy before continuing. Since the Godot editor
...
modules. Some of these are only enabled in
