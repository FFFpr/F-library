...
for which a tutorial is available here.
...
Create a new empty scene, add a root Node and add a script to it.
Then add an HTTPRequest node as a child.

![../../_images/rest_api_scene.png](../../_images/rest_api_scene.png)
...
public partial class MyNode : Node
{
    ...
    {
        HttpRequest httpRequest = GetNode("HTTPRequest");
