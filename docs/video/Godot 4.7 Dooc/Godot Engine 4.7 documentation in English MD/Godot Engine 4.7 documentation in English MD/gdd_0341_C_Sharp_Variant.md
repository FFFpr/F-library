...
also Variant.As{TYPE} methods and the generic Variant.As method. All of these behave the
same.

```csharp
int number = (int)numberVariant;
string hello = (string)helloVariant;
int number2 = numberVariant.As();
...
Godot.Variant or use the generic Variant.As and Variant.From methods
to convert them.
...
Combined with the generic Variant.From allows you to obtain an instance of Godot.Variant
