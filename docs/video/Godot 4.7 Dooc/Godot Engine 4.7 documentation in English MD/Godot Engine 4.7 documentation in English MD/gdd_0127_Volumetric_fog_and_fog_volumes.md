...
As described in Environment and post-processing, Godot supports
...
cannot be customized with Fog shaders.
...
![../../_images/volumetric_fog_comparison.png](../../_images/volumetric_fog_comparison.png)
...
![../../_images/volumetric_fog_lighting.png](../../_images/volumetric_fog_lighting.png)
...
changing its import type in the Import dock.
...
![FogMaterial comparison (without and with density texture)](../../_images/volumetric_fog_fog_material_density_texture.png)
...
FogVolume nodes' appearance can be customized using Fog shaders.
