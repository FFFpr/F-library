...
public:
    ...
    virtual void get_recognized_extensions(List *r_extensions) const;
...
void ResourceFormatLoaderJson::get_recognized_extensions(List *r_extensions) const {
...
public:
    ...
    virtual void get_recognized_extensions(const RES &p_resource, List *r_extensions) const;
};
```
...
void ResourceFormatSaverJson::get_recognized_extensions(const RES &p_resource, List *r_extensions) const {
...
Godot may not have a proper substitute within its Core types
...
Error JsonResource::save_file(const String &p_path, const RES &p_resource) {
    ...
    Ref json_ref = p_resource.get_ref_ptr();
    JSON json;
...
#include "resource_saver_json.h"
#include "resource_json.h"
static Ref json_loader;
static Ref json_saver;
void register_json_types() {
