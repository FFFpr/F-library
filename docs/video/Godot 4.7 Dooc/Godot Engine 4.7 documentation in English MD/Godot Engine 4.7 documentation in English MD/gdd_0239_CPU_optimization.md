...
![Screenshot of the Godot profiler](../../_images/godot_profiler.png)
...
You can use a number of third-party C++ profilers
to do this.

![Screenshot of Callgrind](../../_images/valgrind.png)
