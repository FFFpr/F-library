...
CollisionShape3Ds as direct child nodes.
Indirect child nodes (i.e. children of child nodes) will be ignored and won't be
used as collision shapes. Also, note that you must add a Shape3D
...
See Importing 3D scenes for information on how to export models
