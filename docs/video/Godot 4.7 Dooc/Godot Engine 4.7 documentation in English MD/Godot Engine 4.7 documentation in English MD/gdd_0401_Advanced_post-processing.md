...
generally and, in particular, with the methods outlined in the custom post-processing tutorial.
...
To get around the limitation on using the depth buffer, use a MeshInstance3D
with a QuadMesh primitive. This allows us to use a
...
Set the Mesh in the MeshInstance3D to an ArrayMesh. An
