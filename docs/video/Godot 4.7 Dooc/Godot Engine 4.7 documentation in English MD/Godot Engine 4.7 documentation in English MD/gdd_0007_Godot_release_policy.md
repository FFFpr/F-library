...
Godot 4.8
(master) | Q4 2026 (estimate) | Development. Receives new features, usability and
performance improvements, as well as bug fixes, while under development.
Godot 4.7 | June 2026 | Receives fixes for bugs and security issues, as well as
patches that enable platform support.
Godot 4.6 | January 2026 | Receives fixes for bugs and security issues, as well as
patches that enable platform support.
Godot 4.5 | September 2025 | Receives fixes for security and platform support issues only.
Godot 4.4 | March 2025 | No longer supported (last update: 4.4.1).
Godot 4.3 | August 2024 | No longer supported (last update: 4.3).
Godot 4.2 | November 2023 | No longer supported (last update: 4.2.2).
Godot 4.1 | July 2023 | No longer supported (last update: 4.1.4).
Godot 4.0 | March 2023 | No longer supported (last update: 4.0.4).
Godot 3.7
(3.x) | No ETA for now | Beta. Receives new features, usability and performance
improvements, as well as bug fixes, while under development.
Godot 3.6 | September 2024 | Receives fixes for bugs and security issues, as well as
patches that enable platform support.
Godot 3.5 | August 2022 | No longer supported (last update: 3.5.3).
...
**Legend:**
![supported](../_images/supported.png)

![partial](../_images/partial.png)

![eol](../_images/eol.png)

![unstable](../_images/unstable.png)
...
See Upgrading from Godot 3 to Godot 4 for instructions on migrating a project
...
Upgrading from Godot 3 to Godot 4 open in a separate tab to check which methods
...
See Handling compatibility breakages for more information.
