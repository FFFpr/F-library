...
![../../_images/csg_nodes.png](../../_images/csg_nodes.png)

![../../_images/csg_mesh.png](../../_images/csg_mesh.png)
...
![../../_images/csg_operation_menu.png](../../_images/csg_operation_menu.png)

![../../_images/csg_operation.png](../../_images/csg_operation.png)

### CSGPolygon

The CSGPolygon3D node extrude along a Polygon drawn in
...
![../../_images/csg_poly_mode.png](../../_images/csg_poly_mode.png)

![../../_images/csg_poly.png](../../_images/csg_poly.png)

Note

The Path mode must be provided with a Path3D
node to work. In the Path node, draw the path and the polygon in
CSGPolygon3D will extrude along the given path.

### Custom meshes

Custom meshes can be used for CSGMesh3D as long as the
...
![../../_images/csg_custom_mesh.png](../../_images/csg_custom_mesh.png)
...
![../../_images/csg_manifold_step_1.png](../../_images/csg_manifold_step_1.png)

In the 3D Print tab, under Clean Up, click the Make Manifold button:

![../../_images/csg_manifold_step_2.png](../../_images/csg_manifold_step_2.png)

The mesh should now be manifold, and can be used as a custom mesh.

### CSGCombiner3D

The CSGCombiner3D node is an empty shape used for
...
![../../_images/csg_overdraw.png](../../_images/csg_overdraw.png)

Create a CSGBox3D and name it room, enable Invert Faces and change the
dimensions of your room.

![../../_images/csg_room.png](../../_images/csg_room.png)

![../../_images/csg_room_invert.png](../../_images/csg_room_invert.png)
...
![../../_images/csg_desk.png](../../_images/csg_desk.png)
...
![../../_images/csg_bed_mat.png](../../_images/csg_bed_mat.png)

We will create another CSGCombiner3D named pillow as the child of  bed.
The scene tree should look like this:

![../../_images/csg_bed_tree.png](../../_images/csg_bed_tree.png)
...
![../../_images/csg_pillow_smooth.png](../../_images/csg_pillow_smooth.png)

Select the pillow node and switch the mode to Subtraction; the combined
spheres will cut a hole into the mattress.

![../../_images/csg_pillow_hole.png](../../_images/csg_pillow_hole.png)
...
![../../_images/csg_bed.png](../../_images/csg_bed.png)
...
![../../_images/csg_lamp_pole_stand.png](../../_images/csg_lamp_pole_stand.png)
...
![../../_images/csg_lamp_spin.png](../../_images/csg_lamp_spin.png)

![../../_images/csg_lamp_polygon.png](../../_images/csg_lamp_polygon.png)

![../../_images/csg_lamp_extrude.png](../../_images/csg_lamp_extrude.png)

Adjust the placement of the 3 parts to make it look like a lamp.

![../../_images/csg_lamp.png](../../_images/csg_lamp.png)
...
![../../_images/csg_shelf_big.png](../../_images/csg_shelf_big.png)

Duplicate the CSGBox3D and shorten the dimensions of each axis and change the mode
to Subtraction.

![../../_images/csg_shelf_subtract.png](../../_images/csg_shelf_subtract.png)

![../../_images/csg_shelf_subtract_menu.png](../../_images/csg_shelf_subtract_menu.png)

You've almost built a shelf. Create one more CSGBox3D for dividing the shelf into
two levels.

![../../_images/csg_shelf.png](../../_images/csg_shelf.png)

Position your furniture in your room as you like and your scene should look
this:

![../../_images/csg_room_result.png](../../_images/csg_room_result.png)
...
Godot's Standard Material 3D and ORM Material 3D supports triplanar mapping, which can be
...
The generated CollisionShape3D node must be a child of a StaticBody3D
...
![../../_images/export_as_gltf.png](../../_images/export_as_gltf.png)
