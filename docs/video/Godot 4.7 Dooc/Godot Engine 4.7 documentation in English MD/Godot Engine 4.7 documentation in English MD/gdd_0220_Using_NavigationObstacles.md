...
NavigationObstacle2D and
NavigationObstacle3D  respectively.
...
![Navigation obstacles affecting navigation mesh baking](../../_images/nav_mesh_obstacles.png)
...
![Navigation obstacles discard of unwanted navigation mesh](../../_images/nav_mesh_obstacles_discard.png)
...
![../../_images/nav_mesh_obstacles_properties.png](../../_images/nav_mesh_obstacles_properties.png)
...
NavigationServer2D.ParseSourceGeometryData(navigationMesh, sourceGeometry, GetNode("MyTestRootNode"));
...
NavigationServer3D.ParseSourceGeometryData(navigationMesh, sourceGeometry, GetNode("MyTestRootNode"));
float obstacleElevation = GetNode("MyTestObstacleNode").GlobalPosition.Y;
...
![Static obstacle drawn in the editor to block or contain navigation agents](../../_images/nav_static_obstacle_build.gif)
