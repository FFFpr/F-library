...
Before using a built-in class in a thread, read Thread-safe APIs
...
Thread-safe APIs documentation to understand which engine APIs
...
when modified. Always use a Mutex when accessing
