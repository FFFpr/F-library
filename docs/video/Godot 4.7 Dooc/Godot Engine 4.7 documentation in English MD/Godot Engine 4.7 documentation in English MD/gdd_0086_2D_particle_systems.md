...
Godot provides two different nodes for 2D particles, GPUParticles2D
and CPUParticles2D. GPUParticles2D is more advanced and uses the
...
While GPUParticles2D is configured via a ParticleProcessMaterial
...
![../../_images/particles_convert.png](../../_images/particles_convert.png)
...
![../../_images/particles_material.png](../../_images/particles_material.png)

Your GPUParticles2D node should now be emitting
white points downward.

![../../_images/particles1.png](../../_images/particles1.png)
...
![../../_images/particles2.png](../../_images/particles2.png)
...
![Example of a particle system that uses a flipbook texture](../../_images/particles_flipbook_result.png)
...
![Particle flipbook texture example](../../_images/particles_flipbook_example.png)

Credit: JoesAlotofthings [https://opengameart.org/content/alot-of-particles-indispersal-special-effect-alotofparticles30]
(CC BY 4.0)
...
![Creating a CanvasItemMaterial at the bottom of the particles node inspector](../../_images/particles_flipbook_create_canvasitemmaterial.png)
...
![Configuring the CanvasItemMaterial for the example flipbook texture](../../_images/particles_flipbook_configure_canvasitemmaterial.png)

Configuring the CanvasItemMaterial for the example flipbook texture

Once this is done, the Animation section
...
have a transparent background in an image editor. In GIMP [https://gimp.org],
...
![../../_images/paranim14.gif](../../_images/paranim14.gif)

Lifetime: 4.0

![../../_images/paranim15.gif](../../_images/paranim15.gif)
...
![../../_images/paranim18.gif](../../_images/paranim18.gif)
...
![../../_images/paranim21.gif](../../_images/paranim21.gif)
...
![../../_images/paranim20.gif](../../_images/paranim20.gif)
