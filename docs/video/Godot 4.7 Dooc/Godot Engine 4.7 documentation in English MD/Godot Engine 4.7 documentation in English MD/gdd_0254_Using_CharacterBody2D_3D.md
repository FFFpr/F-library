...
CharacterBody2D node and show some examples
of how to use it.
...
bodies. Please read Physics introduction first, for an overview
...
specific circumstances. See the CharacterBody2D docs
for full details.
...
![../../_images/k2d_compare.gif](../../_images/k2d_compare.gif)
...
public partial class MyCharacterBody2D : CharacterBody2D
{
    private PackedScene _bullet = GD.Load("res://Bullet.tscn");
    ...
    public void Shoot()
    {
        ...
        b.Start(GetNode("Muzzle").GlobalPosition, Rotation);
...
![../../_images/k2d_bullet_bounce.gif](../../_images/k2d_bullet_bounce.gif)
...
![../../_images/k2d_platform.gif](../../_images/k2d_platform.gif)
