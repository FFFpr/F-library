...
As explained in the Debugger panel documentation, Godot features a
...
from the engine's Performance singleton.
...
![Example editor graph from a custom performance monitor](../../../_images/custom_performance_monitors_graph_example.png)
...
monitor registration and getter function to an autoload instead.
