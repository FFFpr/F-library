...
translate the string manually using tr_n().
...
translate the string manually using tr()
or tr_n().
...
![../../_images/import_csv.png](../../_images/import_csv.png)
...
Configuring the imported translation so that the
