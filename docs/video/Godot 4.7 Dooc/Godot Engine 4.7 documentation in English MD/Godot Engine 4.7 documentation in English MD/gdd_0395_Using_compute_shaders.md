...
to shaders please read Introduction to shaders and your
first shader before proceeding with this tutorial.
...
Now to execute our shader we need a local RenderingDevice
which can be created using the RenderingServer:
...
```
// Load GLSL shader
var shaderFile = GD.Load("res://compute_example.glsl");
...
TDR being triggered by Windows.
