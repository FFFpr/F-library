...
display server and Dummy audio driver.
...
![Choosing the **Export as dedicated server** export mode in the export preset](../../_images/exporting_for_dedicated_servers_export_mode.png)
...
![Choosing resources to keep, keep with stripped visuals or remove](../../_images/exporting_for_dedicated_servers_export_resources.png)
