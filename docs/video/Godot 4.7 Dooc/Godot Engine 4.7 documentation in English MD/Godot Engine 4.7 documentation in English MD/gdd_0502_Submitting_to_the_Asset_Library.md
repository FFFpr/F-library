...
As mentioned in the Using the Asset Library document, in order to be able to
...
GDScript style guide or the C# style guide.
...
based on your choice of provider, but it should look similar to https://github.com//.
...
https://github.com///issues. You may leave this field empty
if you use your provider's issue tracker, and it's part of the same repository.
- Download Commit:The commit of the asset. For example,
...
For icons hosted on GitHub, URLs must be provided in the form of https://raw.githubusercontent.com////Icon.png.
...
- Thumbnail URL:A URL to an image that will be used as a thumbnail for the
