...
You can find freely licensed font files on websites such as Google Fonts [https://fonts.google.com/] and Font Library [https://fontlibrary.org/].
...
![Changing import type to Font Data (Image Font)](../../_images/using_fonts_bitmap_font_from_image_import_options.png)
...
![Bitmap font example](../../_images/using_fonts_monospace_bitmap_font_example.png)

Credit: LibreQuake [https://github.com/MissLav/LibreQuake/blob/master/lq1/gfx-wad/CONCHARS.png]
(scaled and cropped to exclude extended range)

The following import options can be used to import the above font image
successfully:

![Import options to use for the above example font](../../_images/using_fonts_bitmap_font_from_image_example_configuration.png)
...
![Diagram showing the advance and offset values being used in character ranges.](../../_images/using_fonts_bitmap_font_advance_offsets_diagram.png)
...
![../../_images/using_fonts_bitmap_kerning_pairs_example.png](../../_images/using_fonts_bitmap_kerning_pairs_example.png)
...
![../../_images/using_fonts_load_font.png](../../_images/using_fonts_load_font.png)
...
by setting CanvasItem.texture_filter.
...
![Font outline example](../../_images/using_fonts_outline_example.png)
...
Label and RichTextLabel. Additionally, font shadows
...
![Configuring font shadow in a Label node](../../_images/using_fonts_shadow.png)

Configuring font shadow in a Label node

The result should look like this:

![Font shadow example](../../_images/using_fonts_shadow_example.png)
...
LabelSettings resource that you reuse across Label nodes. This
resource takes priority over theme properties.
...
![Font antialiasing comparison](../../_images/using_fonts_antialiasing_comparison.png)

From top to bottom: Disabled, Grayscale, LCD Subpixel (RGB)

Note

Antialiasing cannot be changed on MSDF-rendered fonts
...
![Font hinting comparison](../../_images/using_fonts_hinting_comparison.png)
...
can be especially noticeable with 3D text that doesn't have Fixed
...
Font prerendering can be used to alleviate this.
...
![Comparison of font rasterization methods](../../_images/using_fonts_rasterized_vs_msdf_comparison.png)
...
![Enabling MSDF in the font's import options](../../_images/using_fonts_msdf_import_options.png)
...
fallbacks) needs to include them.
Otherwise, emoji won't be displayed and placeholder "tofu" characters will
appear instead:

![Default appearance when trying to use emoji in a label](../../_images/using_fonts_emoji_placeholder_characters.png)
...
![Correct appearance after adding an emoji font to the label](../../_images/using_fonts_emoji_correct_characters.png)
...
fallback font that points to the
...
font to provide emoji glyphs rather than
...
the img tag in RichTextLabel. Unlike
...
specify the icon font as a fallback.
...
![../../_images/using_fonts_advanced_import_settings.png](../../_images/using_fonts_advanced_import_settings.png)
...
![../../_images/using_fonts_font_fallbacks_add.png](../../_images/using_fonts_font_fallbacks_add.png)
...
![../../_images/using_fonts_font_fallbacks_load.png](../../_images/using_fonts_font_fallbacks_load.png)
...
OpenType font features, but this is not covered here
for brevity reasons.
...
To use a variable font, create a FontVariation resource in the
location where you intend to use the font, then load a font file within the
FontVariation resource:

![../../_images/using_fonts_font_variation_create.png](../../_images/using_fonts_font_variation_create.png)

Creating a FontVariation resource

![../../_images/using_fonts_font_variation_load.png](../../_images/using_fonts_font_variation_load.png)
...
![../../_images/using_fonts_font_variation_variable_font.png](../../_images/using_fonts_font_variation_variable_font.png)
...
![../../_images/using_fonts_font_variation_variable_font_example.png](../../_images/using_fonts_font_variation_variable_font_example.png)
...
![../../_images/using_fonts_font_variation_save_to_file.png](../../_images/using_fonts_font_variation_save_to_file.png)
...
increases distribution size. A single variable font
...
![Faux bold/italic (top), real bold/italic (bottom). Normal font used: Open Sans SemiBold](../../_images/using_fonts_faux_bold_italic_vs_real_bold_italic.png)

Faux bold/italic (top), real bold/italic (bottom). Normal font used: Open Sans SemiBold

Faux bold and italic is automatically used in RichTextLabel's bold
...
but also to calculate the minimum size of controls such as Label
and Button.
...
![../../_images/using_fonts_advanced_import_settings_opentype_features.png](../../_images/using_fonts_advanced_import_settings_opentype_features.png)
...
variable font, then load a font file
...
![../../_images/using_fonts_font_variation_opentype_features.png](../../_images/using_fonts_font_variation_opentype_features.png)
...
![../../_images/using_fonts_font_variation_slashed_zero.png](../../_images/using_fonts_font_variation_slashed_zero.png)
...
![../../_images/using_fonts_font_variation_disable_ligatures.png](../../_images/using_fonts_font_variation_disable_ligatures.png)
...
Create a SystemFont resource in the location where you desire to
use the system font:

![../../_images/using_fonts_system_font_create.png](../../_images/using_fonts_system_font_create.png)

Creating a SystemFont resource

![../../_images/using_fonts_system_font_specify.png](../../_images/using_fonts_system_font_specify.png)
...
See Runtime loading and saving
for details.
...
![Adding a new prerendering configuration in the Advanced Import Settings dialog](../../_images/using_fonts_advanced_import_settings_prerender_new_configuration.png)
...
internationalization. Otherwise, stick to
...
![Enabling prerendering in the Advanced Import Settings dialog with the Glyphs from the Translations tab](../../_images/using_fonts_advanced_import_settings_prerender_translation.png)
...
![Enabling prerendering in the Advanced Import Settings dialog, Glyphs from the Text tab](../../_images/using_fonts_advanced_import_settings_prerender_text.png)

Enabling prerendering in the Advanced Import Settings dialog with the Glyphs from the Text tab

Tip

If your project supports internationalization,
...
![Enabling prerendering in the Advanced Import Settings dialog, Glyphs from the Character Map tab](../../_images/using_fonts_advanced_import_settings_prerender_character_map.png)
...
default project font use MSDF font rendering instead
of traditional rasterization.
- Default Font Generate Mipmaps: If true, enables
mipmap generation and
