...
the generic Godot.Collections.Array type only supports items of a type
...
var invalidArray = new Godot.Collections.Array();
// System.Int32 is a valid type because it's compatible with Variant.
var validArray = new Godot.Collections.Array();
```
