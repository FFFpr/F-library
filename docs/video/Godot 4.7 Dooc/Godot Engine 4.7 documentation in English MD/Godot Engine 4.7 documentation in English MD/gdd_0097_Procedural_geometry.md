...
Many things in Godot have mesh in their name: the Mesh, the
ArrayMesh, the ImmediateMesh, the MeshInstance3D, the
MultiMesh, and the MultiMeshInstance3D. While they are all related, they have slightly
different uses.
...
in the Mesh when you use a MeshInstance3D using the material_override property.
...
ArrayMesh.ARRAY_NORMAL is a PackedVector3Array of vertex normals.
