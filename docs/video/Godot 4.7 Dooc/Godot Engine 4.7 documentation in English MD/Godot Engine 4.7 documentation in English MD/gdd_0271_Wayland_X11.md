...
--display-server  command line argument
...
libdecor [https://github.com/neonkore/libdecor] loading on Wayland
...
Godot supports HDR output on Linux since 4.7. However,
