...
func _handles_file(path):
    ...
    # either in the Project Settings or with the `--write-movie ` command line argument.
...
Called once before the engine starts writing video and audio data. movie_size is the width and height of the video to save. fps is the number of frames per second specified in the project settings or using the --fixed-fps  command line argument.
