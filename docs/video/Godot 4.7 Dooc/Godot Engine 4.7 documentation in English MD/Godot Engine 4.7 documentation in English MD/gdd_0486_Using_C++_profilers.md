...
There is a built-in GDScript profiler in the editor,
...
--path  (which runs a project directly).

See also

See Command line tutorial for more command line arguments
supported by Godot.
...
the GitHub Releases page [https://github.com/godotengine/godot-builds/releases].
