...
![../../_images/text_editor.png](../../_images/text_editor.png)
...
in your project, see Using an external text editor and
...
![../../_images/editor_ui_script_editor_open.png](../../_images/editor_ui_script_editor_open.png)
...
![../../_images/editor_ui_script_editor_menu.png](../../_images/editor_ui_script_editor_menu.png)
...
![../../_images/editor_ui_script_editor_script_panel.png](../../_images/editor_ui_script_editor_script_panel.png)

![script](../../_images/Script.png)

![scriptcsharp](../../_images/ScriptCSharp.png)

![documentation](../../_images/Documentation.png)

![toolscript](../../_images/ToolScript.png)

[tool annotation](../plugins/running_code_in_the_editor.xhtml) for more on this).
...
![../../_images/text_editor_menu.png](../../_images/text_editor_menu.png)

The File menu provides the following options:

![../../_images/text_editor_file_menu.png](../../_images/text_editor_file_menu.png)
...
tool, reloads the script to execute it again.
...
scripts.
- Run: If the script extends EditorScript and
intended to be executed without running the project, this option runs the script.
See Running one-off scripts using EditorScript for more.
...
Scripts Panel is explained above.

The Edit menu provides several options for line operations:

![../../_images/text_editor_edit_menu.png](../../_images/text_editor_edit_menu.png)
...
the readability of larger scripts. See Built-in types for more.
  - Fold/Unfold Line*: If the code in the current line has a code block or code region
beneath it, it hides this block by collapsing the lines. You can then unfold it using
this option again, using the ">" arrow next to the line number in the coding area,
or clicking on the ellipsis "..." icon at the end of the folded line.
...
![../../_images/text_editor_search_menu.png](../../_images/text_editor_search_menu.png)
...
![../../_images/editor_ui_script_editor_replaceinfiles.png](../../_images/editor_ui_script_editor_replaceinfiles.png)
...
![../../_images/editor_ui_script_editor_replace_all.png](../../_images/editor_ui_script_editor_replace_all.png)
...
![../../_images/text_editor_goto_menu.png](../../_images/text_editor_goto_menu.png)
...
Script editor debug tools and options for more.
...
interface. To learn more about scripting in Godot, refer to the GDScript or
Scripting documentation.

![../../_images/editor_ui_script_editor_coding_area.png](../../_images/editor_ui_script_editor_coding_area.png)
...
![override](../../_images/override.png)

[override](../scripting/overridable_functions.xhtml) of an existing
function. Clicking it opens the documentation of the original function. The
![receiver](../../_images/receiver.png)

![foldable](../../_images/Foldable.png)
...
Line 55 is a breakpoint that can be used in debugging.

![../../_images/text_editor_coding_area_indicators.png](../../_images/text_editor_coding_area_indicators.png)
