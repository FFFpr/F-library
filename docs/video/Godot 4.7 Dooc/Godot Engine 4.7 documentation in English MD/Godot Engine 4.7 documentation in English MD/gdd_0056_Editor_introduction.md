...
The port can be downloaded from the Meta Horizon Store [https://www.meta.com/experiences/godot-game-engine/7713660705416473/],
...
The Android port can be downloaded from the Android Downloads page [https://godotengine.org/download/android/].
