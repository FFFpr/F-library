...
![../../_images/transforms_euler.png](../../_images/transforms_euler.png)

Euler angles were introduced by mathematician Leonhard Euler in the early 1700s.

![../../_images/transforms_euler_himself.png](../../_images/transforms_euler_himself.png)
...
![../../_images/transforms_gimbal.gif](../../_images/transforms_gimbal.gif)
...
![../../_images/transforms_rotate1.gif](../../_images/transforms_rotate1.gif)

If we were to apply rotation in the X axis first, and then in Y, the effect would be undesired:

![../../_images/transforms_rotate2.gif](../../_images/transforms_rotate2.gif)
...
![../../_images/transforms_interpolate1.gif](../../_images/transforms_interpolate1.gif)

But this does not always have the expected effect when using angles:

![../../_images/transforms_interpolate2.gif](../../_images/transforms_interpolate2.gif)
...
![../../_images/transforms_camera.png](../../_images/transforms_camera.png)

One way to visualize a transform is to look at an object's 3D gizmo while in "local space" mode.

![../../_images/transforms_local_space.png](../../_images/transforms_local_space.png)
...
![../../_images/transforms_gizmo.png](../../_images/transforms_gizmo.png)
...
The Quaternion type reference has more information on the datatype (it
