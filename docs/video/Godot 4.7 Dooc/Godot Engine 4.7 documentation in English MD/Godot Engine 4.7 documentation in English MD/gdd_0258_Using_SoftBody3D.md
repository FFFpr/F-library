...
Additionally, physics interpolation currently
...
or StaticBody3D, it does not have a
CollisionShape3D or a MeshInstance3D
...
![Adjusting BoxMesh properties in the inspector](../../_images/soft_body_box_mesh.png)
...
![Adjusting SoftBody3D simulation properties in the inspector](../../_images/soft_body_inspector.png)
...
![Subdividing the PlaneMesh and placing it on the character's back](../../_images/soft_body_cloak_subdivide.png)
...
Add a BoneAttachment3D node under the skeleton
...
![Configuring the BoneAttachment3D node in the inspector](../../_images/soft_body_cloak_bone_attach.png)
...
![Pinning the SoftBody3D's points in the inspector](../../_images/soft_body_cloak_pinned.png)
...
![Configuring pinned points to be attached to the BoneAttachment3D node in the SoftBody3D inspector](../../_images/soft_body_cloak_pinned_attach.png)
...
![Setting up the collision exception in the SoftBody3D inspector](../../_images/soft_body_cloak_ignore.png)

Setting up the collision exception in the SoftBody3D inspector

Play the scene and the cloak should simulate correctly.

![Final result when running the project's main scene](../../_images/soft_body_cloak_finish.png)
...
See Import configuration and Mesh level of detail (LOD)
for more details.
