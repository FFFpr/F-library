...
3D antialiasing technique (MSAA, FXAA, TAA, SSAA).
...
![Variable rate shading disabled in textured scene](../../_images/variable_rate_shading_textured_disabled.png)

Variable rate shading disabled in textured scene

![Variable rate shading enabled in textured scene (lower quality, but higher performance)](../../_images/variable_rate_shading_textured_enabled.png)
...
![Variable rate shading disabled in untextured scene](../../_images/variable_rate_shading_untextured_disabled.png)

Variable rate shading disabled in untextured scene

![Variable rate shading enabled in untextured scene (lower quality, but higher performance)](../../_images/variable_rate_shading_untextured_enabled.png)
...
For XR, you can use foveation level
as an alternative.
...
![Example VRS density map texture, simulating foveated rendering](../../_images/variable_rate_shading_texture_example.png)
