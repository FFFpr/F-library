...
By default, float is 64-bit in GDScript, but Vector2,
Vector3 and Vector4 are 32-bit. This means that the
...
See the Compiling section for compiling
...
When saving a binary resource using the ResourceSaver singleton,
...
ResourceLoader singleton on resources that use this special flag.
...
- GPUParticles3D nodes with Local Coords disabled will not benefit
...
as well as CPUParticles3D nodes, will still benefit from increased precision.
