...
If you're looking to export your project to Android instead, read Exporting for Android.
...
Exporting for Android tutorial before attempting to build
...
- SCons 4.4+ [https://scons.org/pages/download.html] build system.
- Android SDK

To install the Android SDK, follow the steps here [https://docs.godotengine.org/en/stable/tutorials/export/exporting_for_android.html].
...
- Linux: $HOME/.local/share/godot/export_templates//
- macOS: $HOME/Library/Application Support/Godot/export_templates//

 is of the form major.minor[.patch].status using values from
...
![../../../_images/andtemplates.png](../../../_images/andtemplates.png)
...
- libgodot_android.so is not in libs//
where  is the device's architecture.
