...
public partial class Game : Node
{
    public static CSharpScript MyNode { get; } =
        GD.Load("res://Path/To/MyNode.cs");
    public static PackedScene MyScene { get; } =
        GD.Load("res://Path/To/MyScene.tscn");
    private Node _node;
...
public partial class Main : Node
{
    ...
    public Main()
    {
        ...
        Child.SetScript(GD.Load("res://Path/To/Child.cs"));
...
Scenes help to avoid this performance issue. PackedScene, the base type that scenes inherit from, defines resources
