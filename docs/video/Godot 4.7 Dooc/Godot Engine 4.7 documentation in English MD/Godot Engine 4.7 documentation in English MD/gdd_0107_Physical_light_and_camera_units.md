...
have a CameraAttributes resource assigned to the
...
See Setting up physical camera units
...
If you haven't added a WorldEnvironment and Camera3D
...
![Color temperature chart from 1,000 Kelvin (left) to 12,500 Kelvin (right)](../../_images/physical_light_units_color_temperature_chart.png)
...
After adding a CameraAttributesPhysical resource to the Camera
