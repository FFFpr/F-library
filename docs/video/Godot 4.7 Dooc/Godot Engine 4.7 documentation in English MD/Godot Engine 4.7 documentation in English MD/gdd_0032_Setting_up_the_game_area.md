...
the archive here: Squash the Creeps assets [https://github.com/godotengine/godot-docs-project-starters/releases/download/latest-4.x/3d_squash_the_creeps_starter.zip].

Once you've downloaded it, extract the .zip archive on your computer. Open the
Godot Project Manager and click the Import button.

![../../_images/01.import_button.png](../../_images/01.import_button.png)
...
![../../_images/02.browse_to_project_folder.png](../../_images/02.browse_to_project_folder.png)

Click Import to open the project in the editor.

![../../_images/03.import_and_edit.png](../../_images/03.import_and_edit.png)
...
![../../_images/import_project_to_4.x_prompt.png](../../_images/import_project_to_4.x_prompt.png)
...
![../../_images/04.start_assets.png](../../_images/04.start_assets.png)
...
![../../_images/05.main_node.png](../../_images/05.main_node.png)
...
![../../_images/adding_static_body3D.png](../../_images/adding_static_body3D.png)

Your scene tree should look like this

![../../_images/06.staticbody_node.png](../../_images/06.staticbody_node.png)

A warning sign next to the CollisionShape3D appears because we haven't defined
its shape. If you click the icon, a popup appears to give you more information.

![../../_images/07.collision_shape_warning.png](../../_images/07.collision_shape_warning.png)

To create a shape, select the CollisionShape3D node, head to the Inspector
and click the  field next to the Shape property. Create a new BoxShape3D.
...
![../../_images/09.box_size.png](../../_images/09.box_size.png)
...
The first is by pressing the Use Snap button (or pressing the Y key).
The second is by selecting a node, dragging a handle on the gizmo then holding Ctrl (Cmd on macOS) while holding the selected node.

![../../_images/use_snap.png](../../_images/use_snap.png)
...
![../../_images/move_gizmo_y_axis.png](../../_images/move_gizmo_y_axis.png)

Note

If you can't see the 3D object manipulator like on the image above, ensure
the Transform Mode is active in the toolbar above the view.

![../../_images/14.select_mode_icon.png](../../_images/14.select_mode_icon.png)
...
![../../_images/15.translation_amount.png](../../_images/15.translation_amount.png)
...
![../../_images/ground_down1meter.png](../../_images/ground_down1meter.png)

Let's add a directional light so our scene isn't all grey. Select the Main
node and add a child node DirectionalLight3D.

![../../_images/create_directional_light3d.png](../../_images/create_directional_light3d.png)
...
![../../_images/16.turn_on_shadows.png](../../_images/16.turn_on_shadows.png)

At this point, your project should look like this.

![../../_images/17.project_with_light.png](../../_images/17.project_with_light.png)
