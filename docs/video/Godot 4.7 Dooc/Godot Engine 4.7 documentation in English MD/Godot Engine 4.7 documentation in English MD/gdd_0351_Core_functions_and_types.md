...
This means that, in general, you can use the Engine details section to learn how to
...
Please refer to Common engine methods and macros for information on this. The functions and macros documented
there are also available in godot-cpp.

## Core types

Godot's Core types are also available in godot-cpp, and the same recommendations apply
