...
![../../_images/bezier_quadratic_points.png](../../_images/bezier_quadratic_points.png)
...
![../../_images/bezier_quadratic_points2.gif](../../_images/bezier_quadratic_points2.gif)
...
![../../_images/bezier_cubic_points.png](../../_images/bezier_cubic_points.png)
...
![../../_images/bezier_cubic_points.gif](../../_images/bezier_cubic_points.gif)
...
![../../_images/bezier_cubic_handles.png](../../_images/bezier_cubic_handles.png)
...
![../../_images/bezier_path_2d.png](../../_images/bezier_path_2d.png)
...
![../../_images/bezier_interpolation_speed.gif](../../_images/bezier_interpolation_speed.gif)
...
![../../_images/bezier_point_amount.png](../../_images/bezier_point_amount.png)
...
To make this easier, the curves need to be baked into equidistant points. This way, they can be approximated with regular interpolation (which can be improved further with a cubic option). To do this, just use the Curve3D.sample_baked() method together with
Curve2D.get_baked_length(). The first call to either of them will bake the curve internally.
...
![../../_images/bezier_interpolation_baked.gif](../../_images/bezier_interpolation_baked.gif)
