...
please read Using TileSets first as you will need a TileSet
to create a TileMap.

## Introduction

A tilemap is a grid of tiles used to create a game's layout. There are several
benefits to using TileMapLayer nodes to design your levels.
First, they make it possible to draw the layout by "painting" the tiles onto a
grid, which is much faster than placing individual Sprite2D
...
If you've followed the previous page on Using TileSets, you should
...
![Saving the built-in TileSet resource to an external resource file](../../_images/using_tilemaps_save_tileset_to_resource.png)
...
![Opening the TileMap panel at the bottom of the editor. The TileMapLayer node must be selected first.](../../_images/using_tilemaps_open_tilemap_editor.png)
...
![Selecting a layer to paint on in the TileMap editor](../../_images/using_tilemaps_select_layer.png)
...
![Selecting a tile in the TileMap editor by clicking it](../../_images/using_tilemaps_select_single_tile_from_tileset.png)
...
![Selecting multiple tiles in the TileMap editor by holding down the left mouse button](../../_images/using_tilemaps_select_multiple_tiles_from_tileset.png)
...
![Selecting an alternative tile in the TileMap editor](../../_images/using_tilemaps_use_alternative_tile.png)
...
![Placing a scene tile containing particles using the TileMap editor](../../_images/using_tilemaps_placing_scene_tiles.png)
...
Ctrl + V another time to perform more pastes this way.
...
![Using the line tool after selecting two tiles to draw platforms diagonally](../../_images/using_tilesets_line_tool_multiple_tiles.png)
...
![Using the Bucket Fill tool](../../_images/using_tilemaps_bucket_fill.png)
...
![Selecting from several times to randomly choose, then painting by holding down the left mouse button](../../_images/using_tilemaps_scatter_tiles.png)
...
![Using Bucket Fill tool with a single tile, but with randomization and scattering enabled](../../_images/using_tilemaps_bucket_fill_scatter.png)
...
![Creating a new pattern from a selection in the TileMap editor](../../_images/using_tilemaps_create_pattern.png)
...
![Placing an existing pattern using the TileMap editor](../../_images/using_tilemaps_use_pattern.png)
...
Creating terrain sets (autotiling) if you haven't created a terrain
...
![Selecting Connect mode in the TileMap editor's Terrains tab](../../_images/using_tilemaps_terrain_select_connect_mode.png)

Selecting Connect mode in the TileMap editor's Terrains tab

![Selecting Path mode in the TileMap editor's Terrains tab](../../_images/using_tilemaps_terrain_select_path_mode.png)
...
![Painting with specific tiles in the TileMap editor's Terrains tab](../../_images/using_tilemaps_terrain_paint_specific_tiles.png)
...
![Missing tiles in the TileMap editor due to the TileSet reference being broken](../../_images/using_tilemaps_missing_tiles.png)
