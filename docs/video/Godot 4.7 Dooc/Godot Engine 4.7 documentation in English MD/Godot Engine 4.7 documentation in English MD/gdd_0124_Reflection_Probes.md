...
As stated in the Standard Material 3D and ORM Material 3D, objects can show reflected and/or
...
more accurate reflections than VoxelGI and
...
low-end alternative to VoxelGI and SDFGI when baked lightmaps aren't viable (e.g. in procedurally generated levels).
...
![Reflection probe disabled. Environment sky is used as a fallback.](../../../_images/gi_none.png)

Reflection probe disabled. Environment sky is used as a fallback.

![Reflection probe enabled.](../../../_images/gi_none_reflection_probe.png)

Reflection probe enabled.

![Reflection probe enabled.](../../../_images/gi_lightmap_gi_indirect_only_reflection_probe.png)
...
![Reflections in a room using ReflectionProbe only.](../../../_images/reflection_probes_reflection_probe.png)

Reflections in a room using ReflectionProbe only. Notice how small details
don't have any reflections.

![Reflections in a room using screen-space reflections only.](../../../_images/reflection_probes_ssr.png)
...
![Reflections in a room using ReflectionProbe and screen-space reflections together.](../../../_images/reflection_probes_reflection_probe_ssr.png)
...
reflections with shadows every frame. Fully baked light
