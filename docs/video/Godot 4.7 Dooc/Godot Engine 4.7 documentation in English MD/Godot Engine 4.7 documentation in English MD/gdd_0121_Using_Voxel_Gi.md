...
![VoxelGI disabled.](../../../_images/gi_none.png)

VoxelGI disabled.

![VoxelGI enabled.](../../../_images/gi_voxel_gi.png)
...
to make use of custom shaders (ShaderMaterial). These meshes will be
...
For BaseMaterial3D, some properties are currently ignored during baking.
...
See Which global illumination mode should I use on meshes and lights?
