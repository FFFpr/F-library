...
- Recording cutscenes that will be displayed as pre-recorded videos
...
post-process to generate high-quality motion blur.
...
![Movie Maker mode is disabled, click the "movie reel" icon to enable](../../_images/creating_movies_enable_movie_maker_mode.png)
...
![Movie Maker mode is enabled, click the "movie reel" icon again to disable](../../_images/creating_movies_disable_movie_maker_mode.png)
...
![Movie Maker project settings (with Advanced toggle enabled)](../../_images/creating_movies_project_settings.png)
...
![Inspector view after creating a ``movie_file`` metadata of type String](../../_images/creating_movies_set_per_scene_metadata.png)
...
Rendering at a higher resolution than the screen resolution if you need to record
...
Godot has 3 built-in MovieWriters, and more can be
...
The resulting file can be viewed in Godot with VideoStreamPlayer and most video players but not web browsers. OGV
...
On the other hand, OGV playback
...
to be
encoded to a video file with an external tool after recording.
...
When using the disabled or 2d stretch modes,
...
Using a video converter program
...
The movie feature tag can be used to override
...
By default, Godot uses the disabled stretch modes
...
See Reducing framerate if you want to get this benefit
