...
The shader preprocessor is not available in visual shaders.
...
Syntax: #define  [replacement_code].
...
error. To prevent this, use #undef .
...
menu option of the shader editor, or by creating a new ShaderInclude resource
