...
For 2D topics not covered in this section, see also 2D skeletons and
2D navigation overview. For using physics in 2D, see
Physics. There is also a step-by-step tutorial on creating a 2D
game in Your first 2D game.
