...
Model export considerations and
Node type customization using name suffixes articles
...
![Import dock after selecting a 3D scene in the FileSystem dock](../../../_images/importing_3d_scenes_import_dock.png)
...
preview models and animations. please see the Advanced Import Settings
page for more information.
- Import hints, which are special
...
See Mesh level of detail (LOD) for more information.
...
Static and generates UV2 on import for lightmap baking.
...
- Use Named Skins: If checked, use named Skins for animation.
The MeshInstance3D node contains 3 properties of relevance here: a skeleton
NodePath pointing to the Skeleton3D node (usually ..), a mesh, and a skin:

The Skeleton3D node contains a list of bones with names, their pose and rest,
...
See Using import scripts for automation for more information.
...
![Changing the import type to Animation Library in the Import dock](../../../_images/importing_3d_scenes_changing_import_type.png)
...
glTF file will be imported as an AnimationLibrary instead of a
PackedScene. This animation library can then be referenced in an
...
Using the Import dock for more information.
...
![Dialog when opening an imported 3D scene in the editor](../../../_images/importing_3d_scenes_create_inherited_scene_dialog.png)
