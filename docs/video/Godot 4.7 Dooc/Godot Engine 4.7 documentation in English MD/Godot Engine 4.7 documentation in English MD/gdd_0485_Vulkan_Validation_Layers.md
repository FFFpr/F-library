...
command line argument. You can also specify
...
Compiling for macOS. If testing validation layers on an exported
...
You can use Godot's One-click deploy feature to quickly test your project with the validation layers enabled.
