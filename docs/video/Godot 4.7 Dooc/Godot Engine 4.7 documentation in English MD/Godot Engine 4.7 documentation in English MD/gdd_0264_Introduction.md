...
physics proceeds at a fixed tick rate (set in Project Settings > Physics > Common > Physics Tick per Second),
...
![../../../_images/fti_graph_fixed_ticks.png](../../../_images/fti_graph_fixed_ticks.png)
...
![../../../_images/fti_graph_interpolated.png](../../../_images/fti_graph_interpolated.png)
...
for you by Godot. It can be retrieved on any frame by calling Engine.get_physics_interpolation_fraction.
