...
![../../_images/tuto_cutout_walk.gif](../../_images/tuto_cutout_walk.gif)
...
![../../_images/tuto_cutout1.png](../../_images/tuto_cutout1.png)
...
![../../_images/tuto_cutout2.png](../../_images/tuto_cutout2.png)
...
![../../_images/tuto_cutout3.png](../../_images/tuto_cutout3.png)
...
![../../_images/tutovec_torso1.gif](../../_images/tutovec_torso1.gif)

The rotation pivot is wrong and needs to be adjusted.

This small cross in the middle of the Sprite2D is
the rotation pivot:

![../../_images/tuto_cutout4.png](../../_images/tuto_cutout4.png)
...
![../../_images/tuto_cutout5.png](../../_images/tuto_cutout5.png)
...
![../../_images/tutovec_torso2.gif](../../_images/tutovec_torso2.gif)
...
![../../_images/tuto_cutout6.png](../../_images/tuto_cutout6.png)

With the left arm there's a problem. In 2D, child nodes appear in front of
their parents:

![../../_images/tuto_cutout7.png](../../_images/tuto_cutout7.png)
...
![../../_images/tuto_cutout9.png](../../_images/tuto_cutout9.png)
...
![../../_images/tutovec_torso4.gif](../../_images/tutovec_torso4.gif)
...
![../../_images/tuto_cutout10.png](../../_images/tuto_cutout10.png)
...
![../../_images/tuto_cutout11.png](../../_images/tuto_cutout11.png)

Then, click on the Skeleton menu and select Make Bones.

![../../_images/tuto_cutout12.png](../../_images/tuto_cutout12.png)

This will add bones covering the arm, but the result may be surprising.

![../../_images/tuto_cutout13.png](../../_images/tuto_cutout13.png)
...
but Marker2D is preferred because it's
visible in the editor. The endpoint node will ensure that the last bone
has orientation.

![../../_images/tuto_cutout14.png](../../_images/tuto_cutout14.png)

Now select the whole chain, from the endpoint to the arm and create
bones:

![../../_images/tuto_cutout15.png](../../_images/tuto_cutout15.png)
...
![../../_images/tuto_cutout15_2.png](../../_images/tuto_cutout15_2.png)

Your final skeleton should look something like this:

![../../_images/tuto_cutout16.png](../../_images/tuto_cutout16.png)
...
![../../_images/tuto_cutout17.png](../../_images/tuto_cutout17.png)

Then enable this chain for IK. Go to Edit > Make IK Chain.

![../../_images/tuto_cutout18.png](../../_images/tuto_cutout18.png)

As a result, the base of the chain will turn Yellow.

![../../_images/tuto_cutout19.png](../../_images/tuto_cutout19.png)
...
![../../_images/tutovec_torso5.gif](../../_images/tutovec_torso5.gif)
...
![../../_images/tuto_cutout20.png](../../_images/tuto_cutout20.png)
...
![../../_images/tuto_cutout21.png](../../_images/tuto_cutout21.png)
...
![../../_images/tuto_cutout22.png](../../_images/tuto_cutout22.png)
...
![../../_images/tuto_cutout23.png](../../_images/tuto_cutout23.png)
...
![../../_images/tuto_cutout24.png](../../_images/tuto_cutout24.png)
