...
![../../_images/spring_arm_position_length.png](../../_images/spring_arm_position_length.png)
...
![../../_images/spring_arm_shape.png](../../_images/spring_arm_shape.png)
...
![../../_images/spring_arm_children.png](../../_images/spring_arm_children.png)
...
![../../_images/spring_arm_camera_shape.png](../../_images/spring_arm_camera_shape.png)
...
![../../_images/spring_arm_camera_motion_cast.png](../../_images/spring_arm_camera_motion_cast.png)

When the shape hits something, the camera will be placed at or near the collision point:

![../../_images/spring_arm_camera_collision.png](../../_images/spring_arm_camera_collision.png)
...
![../../_images/spring_arm_editor_setup.png](../../_images/spring_arm_editor_setup.png)

Let's move the pivot point up by 2 on the Y-axis so that it's not on the ground:

![../../_images/spring_arm_pivot_setup.png](../../_images/spring_arm_pivot_setup.png)

Give the spring arm a length of 3 so that it is placed behind the character:

![../../_images/spring_arm_length_setup.png](../../_images/spring_arm_length_setup.png)

Note

Leave the Shape of the spring arm as . This way, it will use the camera's pyramid shape.
