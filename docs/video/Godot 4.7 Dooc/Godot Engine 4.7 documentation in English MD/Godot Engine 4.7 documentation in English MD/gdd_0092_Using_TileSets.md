...
![Tilesheet example with 64×64 tiles](../../_images/using_tilesets_kenney_abstract_platformer_tile_sheet.png)
...
![Creating a new TileSet resource within the TileMapLayer node](../../_images/using_tilesets_create_new_tileset.png)
...
![Setting the tile size to 64×64 to match the example tilesheet](../../_images/using_tilesets_specify_size_then_edit.png)
...
![Automatically creating tiles based on tilesheet image content](../../_images/using_tilesets_create_tiles_automatically.png)
...
![Using the Eraser tool to remove unwanted tiles from the TileSet atlas](../../_images/using_tilesets_eraser_tool.png)
...
![Adjusting TileSet atlas properties in the dedicated inspector (part of the TileSet panel)](../../_images/using_tilesets_properties.png)
...
![Recreating tiles automatically after changing atlas properties](../../_images/using_tilesets_recreate_tiles_automatically.png)
...
![Creating a scenes collection in the TileSet editor](../../_images/using_tilesets_creating_scene_collection.png)
...
![Creating a scene tile after selecting the scenes collection in the TileSet editor](../../_images/using_tilesets_scene_collection_create_scene_tile.png)
...
![Creating a scene slot, then loading a scene file into it in the TileSet editor](../../_images/using_tilesets_adding_scene_tile.png)
...
![Opening the atlas merging tool after creating multiple atlases](../../_images/using_tilesets_open_atlas_merging_tool.png)
...
![Using the atlas merging tool dialog](../../_images/using_tilesets_atlas_merging_tool_dialog.png)
...
![Creating a physics layer in the TileSet resource inspector (within the TileMapLayer node)](../../_images/using_tilesets_create_physics_layer.png)
...
![Creating a navigation layer in the TileSet resource inspector (within the TileMapLayer node)](../../_images/using_tilesets_create_navigation_layer.png)
...
![Creating an occlusion layer in the TileSet resource inspector (within the TileMapLayer node)](../../_images/using_tilesets_create_occlusion_layer.png)
...
![Opening the collision editor while in Select mode](../../_images/using_tilesets_selecting_collision_editor.png)
...
![Using default rectangle collision shape by pressing :kbd:`F`](../../_images/using_tilesets_using_default_rectangle_collision.png)
...
![Creating a triangle collision shape by right-clicking one of the corners to remove it](../../_images/using_tilesets_creating_triangle_collision.png)
...
![Drawing a custom collision for a complex tile shape](../../_images/using_tilesets_drawing_custom_collision.png)
...
![Creating a custom data layer in the TileSet resource inspector (within the TileMapLayer node)](../../_images/using_tilesets_create_custom_data_layer.png)

Creating a custom data layer in the TileSet resource inspector (within the TileMapLayer node)

![Example of configured custom data layers with game-specific properties](../../_images/using_tilesets_custom_data_layers_example.png)
...
![Editing custom data in the TileSet editor while in Select mode](../../_images/using_tilesets_edit_custom_data.png)
...
![Assigning custom data in the TileSet editor using tile property painting](../../_images/using_tilesets_paint_custom_data.png)
...
![Creating a terrain set in the TileSet resource inspector (within the TileMapLayer node)](../../_images/using_tilesets_create_terrain_set.png)
...
![Creating a terrain within the terrain set](../../_images/using_tilesets_create_terrain.png)
...
![Configuring terrain on a single tile in the TileSet editor's Select mode](../../_images/using_tilesets_configure_terrain_on_tile.png)
...
![Configuring terrain peering bits on a single tile in the TileSet editor's Select mode](../../_images/using_tilesets_configure_terrain_peering_bits.png)
...
![Example full tilesheet for a sidescrolling game](../../_images/using_tilesets_terrain_example_tilesheet.png)

Example full tilesheet for a sidescrolling game

![Example full tilesheet for a sidescrolling game with terrain peering bits visible](../../_images/using_tilesets_terrain_example_tilesheet_configuration.png)
...
![Selecting multiple tiles using the Select mode, then applying properties](../../_images/using_tilesets_select_and_set_tile_properties.png)
...
![Painting tile properties using the TileSet editor](../../_images/using_tilesets_paint_tile_properties.png)
...
![Painting a collision polygon, then left-clicking tiles to apply it](../../_images/using_tilesets_paint_tile_properties_collision.png)
...
![Creating an alternative tile by right-clicking a base tile in the TileSet editor](../../_images/using_tilesets_create_alternative_tile.png)
...
![Configuring an alternative tile after clicking it in the TileSet editor](../../_images/using_tilesets_configure_alternative_tile.png)
