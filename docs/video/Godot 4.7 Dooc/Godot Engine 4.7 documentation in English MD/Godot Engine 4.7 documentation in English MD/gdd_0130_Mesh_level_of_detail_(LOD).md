...
![From most detailed (left) to least detailed (right), shaded view](../../_images/mesh_lod_comparison_shaded.png)
...
![From most detailed (left) to least detailed (right), wireframe view](../../_images/mesh_lod_comparison_wireframe.png)
...
![Changing the import type on an OBJ file in the Import dock](../../_images/mesh_lod_obj_import.png)
...
![Disabling mesh LOD in the 3D viewport's top-left menu](../../_images/mesh_lod_disable_lod.png)
