...
```gdscript
sdkmanager --sdk_root= "platform-tools" "build-tools;35.0.1" "platforms;android-35" "cmdline-tools;latest" "cmake;3.10.2.4988404" "ndk;28.1.13356709"
```
...
![../../_images/editorsettings.png](../../_images/editorsettings.png)

Scroll down to the section where the Android settings are located:

![../../_images/android_editor_settings.png](../../_images/android_editor_settings.png)
...
- Adaptive Icons: Starting from Android 8 (inclusive), Adaptive Icons [https://developer.android.com/develop/ui/compose/system/icon_design_adaptive] were introduced. Applications will need to include separate background and foreground icons to have a native look. The user's launcher application will control the icon's animation and masking. Must be at least 432×432 px.
...
![../../_images/editor-export-presets-android.png](../../_images/editor-export-presets-android.png)
...
![../../_images/export-with-debug-button.png](../../_images/export-with-debug-button.png)
...
only the features you need. See Optimizing a build for size for more
information.
...
EditorExportPlatformAndroid class reference.
