...
In traditional first person games a player is represented by a CharacterBody3D node.
...
Applying this model to the XR setup, we add an XROrigin3D node as a child of the character body,
and add an XRCamera3D as a child of the origin node. At face value this seems to work.
...
![../../_images/XRRoomCenterWalk.gif](../../_images/XRRoomCenterWalk.gif)
...
![../../_images/XRRoomWalkOffCliff.gif](../../_images/XRRoomWalkOffCliff.gif)
...
![../../_images/XRRoomRotateOrigin.gif](../../_images/XRRoomRotateOrigin.gif)
...
![../../_images/XRRoomWalkWall.gif](../../_images/XRRoomWalkWall.gif)
...
![../../_images/xr_room_scale_origin_body.png](../../_images/xr_room_scale_origin_body.png)
...
![../../_images/xr_room_scale_character_body.png](../../_images/xr_room_scale_character_body.png)
