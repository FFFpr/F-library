...
![../../_images/environment_camera.png](../../_images/environment_camera.png)
...
![../../_images/environment_world.png](../../_images/environment_world.png)
...
![../../_images/environment_preview_sun_sky_toggle.png](../../_images/environment_preview_sun_sky_toggle.png)
...
![../../_images/environment_preview_sun_sky_dialog.png](../../_images/environment_preview_sun_sky_dialog.png)
...
The CameraAttributes resource stores exposure and depth of field
...
Using a CameraAttributesPhysical on a Camera3D node will lock
...
![../../_images/environment_background1.png](../../_images/environment_background1.png)
...
- Camera Feed displays a CameraFeed from a physical camera as the
...
![../../_images/environment_ambient2.png](../../_images/environment_ambient2.png)
...
generate ambient light from ReflectionProbe,
VoxelGI or SDFGI, as these
...
![../../_images/environment_ambient_comparison.png](../../_images/environment_ambient_comparison.png)
...
Screen-space effects such as SSR,
SSAO,
SSIL and glow do not operate on
...
Reflection probes, they may not provide enough detail for all
...
![../../_images/environment_ssr.png](../../_images/environment_ssr.png)
...
![../../_images/environment_ssao.png](../../_images/environment_ssao.png)

It is a common mistake to enable this effect, turn on a light, and not be able to
appreciate it. This is because SSAO
...
SSAO to work with direct light too,
use the Light Affect parameter. Even though this is not physically correct,
some artists like how it looks.

SSAO looks best when combined with a
real source of indirect light, like VoxelGI:

![../../_images/environment_ssao2.png](../../_images/environment_ssao2.png)

Tweaking SSAO is possible with several
parameters:

![../../_images/environment_ssao_parameters.png](../../_images/environment_ssao_parameters.png)
...
Since SSAO is a screen-space effect,
it's recommended to remain conservative with this value.
SSAO that is too strong can be
...
make the SSAO effect visible in
...
SSIL provides indirect lighting for
...
offered by other 3D engines. SSIL
can be combined with SSR and/or
SSAO for greater visual quality
...
![../../_images/environment_ssil.png](../../_images/environment_ssil.png)
...
illumination for off-screen elements (unlike SSIL).

See also

See Signed distance field global illumination (SDFGI) for instructions on setting up this global
illumination technique.

![../../_images/environment_sdfgi.png](../../_images/environment_sdfgi.png)
...
![../../_images/environment_glow1.png](../../_images/environment_glow1.png)
...
![../../_images/environment_glow_threshold.png](../../_images/environment_glow_threshold.png)
...
![../../_images/environment_glow_bloom.png](../../_images/environment_glow_bloom.png)
...
![../../_images/environment_glow_layers.png](../../_images/environment_glow_layers.png)

The real strength of this system, though, is to combine levels to create more
interesting glow patterns:

![../../_images/environment_glow_layers2.png](../../_images/environment_glow_layers2.png)
...
![../../_images/environment_glow_map.png](../../_images/environment_glow_map.png)
...
![../../_images/environment_and_post_processing_glow_scale_mode.png](../../_images/environment_and_post_processing_glow_scale_mode.png)
...
CanvasLayer node. You can control which layers are affected by
...
![Example of using glow in a 2D scene](../../_images/environment_and_post_processing_glow_in_2d.png)
...
when using the Canvas background mode, make them children of a CanvasLayer
...
![Example of using glow to blur the 2D rendering in the menu's background](../../_images/environment_and_post_processing_glow_blur.png)
...
It is possible to use both non-volumetric fog and Volumetric fog and fog volumes
at the same time.
...
![../../_images/environment_fog_depth_height.png](../../_images/environment_fog_depth_height.png)
...
higher density levels. See Color banding
...
![../../_images/environment_adjustments.png](../../_images/environment_adjustments.png)
...
![../../_images/environment_adjustments_bcs.png](../../_images/environment_adjustments_bcs.png)
...
![../../_images/environment_adjustments_default_gradient.png](../../_images/environment_adjustments_default_gradient.png)

But creating custom ones will allow to map each channel to a different color:

![../../_images/environment_adjustments_custom_gradient.png](../../_images/environment_adjustments_custom_gradient.png)
...
![../../_images/environment_adjustments_3d_lut_import.png](../../_images/environment_adjustments_3d_lut_import.png)
...
![../../_images/environment_adjustments_3d_lut_template.png](../../_images/environment_adjustments_3d_lut_template.png)
...
![../../_images/environment_adjustments_3d_lut_comparison.png](../../_images/environment_adjustments_3d_lut_comparison.png)
...
![../../_images/environment_dof_far.png](../../_images/environment_dof_far.png)
...
![../../_images/environment_dof_near.png](../../_images/environment_dof_near.png)
...
![../../_images/environment_mixed_blur.png](../../_images/environment_mixed_blur.png)
...
![tutorials/3d/img/environment_hdr_autoexp.png](tutorials/3d/img/environment_hdr_autoexp.png)
...
By combining Auto Exposure with Glow
...
![../../_images/environment_hdr_bloom.png](../../_images/environment_hdr_bloom.png)

The user-controllable values in the Auto Exposure section come with sensible
defaults, but you can still tweak them:

![../../_images/environment_hdr.png](../../_images/environment_hdr.png)
...
See Physical light and camera units if you wish to use real world
