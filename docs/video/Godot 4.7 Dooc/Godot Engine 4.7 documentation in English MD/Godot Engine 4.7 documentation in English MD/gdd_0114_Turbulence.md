...
![Particle turbulence](tutorials/3d/particles/img/particle_turbulence.png)

Turbulence uses a noise texture to add variation and interesting patterns to particle movement.
It can be combined with particle attractors and
collision nodes to create even more complex looking behavior.

![Turbulence properties](../../../_images/particle_turbulence_properties.png)
...
to follow a more complex movement path. Second, you need to enable turbulence in the particle process material.
...
![Turbulence noise strength](../../../_images/particle_turbulence_strength.png)
...
![Turbulence noise scale](../../../_images/particle_turbulence_scale.png)
...
![Turbulence noise speed](tutorials/3d/particles/img/particle_turbulence_speed.png)
...
![Turbulence influence](../../../_images/particle_turbulence_influence.png)
...
![Turbulence displacement](../../../_images/particle_turbulence_displacement.png)
