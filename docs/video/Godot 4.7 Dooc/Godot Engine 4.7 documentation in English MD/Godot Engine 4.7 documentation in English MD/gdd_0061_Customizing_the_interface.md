...
![Resizing a dock in the editor](../../_images/editor_ui_resize_dock.png)
...
![Moving a dock in the editor](../../_images/editor_ui_move_dock.png)
...
![Splitting the script editor to its own window](../../_images/editor_ui_split_script_editor.png)
...
![Splitting the shader editor to its own window](../../_images/editor_ui_split_shader_editor.png)
...
![The Editor Settings window](../../_images/editor_settings.png)
...
See the EditorSettings class reference for a complete description
