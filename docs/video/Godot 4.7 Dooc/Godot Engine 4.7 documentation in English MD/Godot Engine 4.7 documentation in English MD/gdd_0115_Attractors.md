...
![Particle attractors](tutorials/3d/particles/img/particle_attractor.png)
...
of attractors: GPUParticlesAttractorBox3D, GPUParticlesAttractorSphere3D,
and GPUParticlesAttractorVectorField3D. You can instantiate them at runtime and
...
![Common particle attractor properties](../../../_images/particle_attractor_common.png)
...
![Different attractor attenuation curves](../../../_images/particle_attractor_curve.png)
...
![Different attractor directionality values](tutorials/3d/particles/img/particle_attractor_direction.png)
...
![Particle attractor box](../../../_images/particle_attractor_box_entry.png)
...
![Box attractor parts particle field](tutorials/3d/particles/img/particle_attractor_box.png)

A box attractor with a negative strength value parts a particle field as it moves through it.

## Sphere attractors

![Particle attractor sphere](../../../_images/particle_attractor_sphere_entry.png)
...
![Sphere attractor parts particle field](tutorials/3d/particles/img/particle_attractor_sphere.png)

A sphere attractor with a negative strength value parts a particle field as it moves through it.

## Vector field attractors

![Particle attractor vector field](../../../_images/particle_attractor_vector_entry.png)
...
![Mapping from texture to vector field](../../../_images/particle_attractor_vector_mapping.png)
...
![Vector field attractor in a field of particles](tutorials/3d/particles/img/particle_attractor_vector.png)
