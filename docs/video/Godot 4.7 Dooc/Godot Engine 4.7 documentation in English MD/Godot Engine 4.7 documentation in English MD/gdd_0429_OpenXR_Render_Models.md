...
This node must have an XROrigin3D node as an
ancestor.
...
![../../_images/openxr_render_models_setup.png](../../_images/openxr_render_models_setup.png)
...
We have an XRController3D that will track the
...
As a child of the node we have an AnimatableBody3D
...
The OpenXRRenderModel node implements
...
OpenXRRenderModelManager nodes,
