...
In Setting up XR we introduced a startup script that initialises our setup which we used as our script on our main node.
...
See OpenXR Settings for further details.

We hook up a number of signals that will be emitted by the XRInterface.
