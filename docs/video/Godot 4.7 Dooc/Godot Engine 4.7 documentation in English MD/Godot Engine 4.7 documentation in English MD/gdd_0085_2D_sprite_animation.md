...
First, we'll use AnimatedSprite2D to
...
![../../_images/2d_animation_run_preview.gif](../../_images/2d_animation_run_preview.gif)
...
![../../_images/2d_animation_tree1.png](../../_images/2d_animation_tree1.png)
...
![../../_images/2d_animation_new_spriteframes.png](../../_images/2d_animation_new_spriteframes.png)

Click on the new SpriteFrames resource and you'll see a new panel appear at the
bottom of the editor window:

![../../_images/2d_animation_spriteframes.png](../../_images/2d_animation_spriteframes.png)

From the FileSystem dock on the left side, drag the 8 individual images into
the center part of the SpriteFrames panel. On the left side, change the name
of the animation from "default" to "run".

![../../_images/2d_animation_spriteframes_done.png](../../_images/2d_animation_spriteframes_done.png)
...
![../../_images/2d_animation_frog_spritesheet.png](../../_images/2d_animation_frog_spritesheet.png)
...
![../../_images/2d_animation_add_from_spritesheet.png](../../_images/2d_animation_add_from_spritesheet.png)
...
![../../_images/2d_animation_spritesheet_select_rows.png](../../_images/2d_animation_spritesheet_select_rows.png)
...
![../../_images/2d_animation_spritesheet_selectframes.png](../../_images/2d_animation_spritesheet_selectframes.png)
...
![../../_images/2d_animation_spritesheet_animation.png](../../_images/2d_animation_spritesheet_animation.png)

Finally, check the play button on the SpriteFrames editor to see your frog jump!

![../../_images/2d_animation_play_spritesheet_animation.png](../../_images/2d_animation_play_spritesheet_animation.png)

## Sprite sheet with AnimationPlayer

Another way that you can animate when using a sprite sheet is to use a standard
Sprite2D node to display the texture, and then animating the
change from texture to texture with AnimationPlayer.

Consider this sprite sheet, which contains 6 frames of animation:

![../../_images/2d_animation_player-run.png](../../_images/2d_animation_player-run.png)
...
![../../_images/2d_animation_tree2.png](../../_images/2d_animation_tree2.png)
...
![../../_images/2d_animation_setframes.png](../../_images/2d_animation_setframes.png)
...
![../../_images/2d_animation_new_animation.png](../../_images/2d_animation_new_animation.png)

Now select the Sprite2D node and click the key icon to add a new track.

![../../_images/2d_animation_new_track.png](../../_images/2d_animation_new_track.png)

Continue adding frames at each point in the timeline (0.1 seconds by
default), until you have all the frames from 0 to 5. You'll see the frames
actually appearing in the animation track:

![../../_images/2d_animation_full_animation.png](../../_images/2d_animation_full_animation.png)

Press "Play" on the animation to see how it looks.

![../../_images/2d_animation_running.gif](../../_images/2d_animation_running.gif)
