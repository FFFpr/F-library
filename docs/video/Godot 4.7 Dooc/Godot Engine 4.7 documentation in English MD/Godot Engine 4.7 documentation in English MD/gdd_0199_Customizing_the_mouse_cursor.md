...
![../../_images/cursor_project_settings.png](../../_images/cursor_project_settings.png)
...
Check Input.set_custom_mouse_cursor()'s
...
Input.CursorShape enum. Which ones you want to use
