...
![../../_images/screenres.png](../../_images/screenres.png)
...
resolution scaling support. This is a good way
...
game embedding is configured to use the Stretch to Fit
scaling option:

![../../_images/multiple_resolutions_game_embedding_size_dropdown.png](../../_images/multiple_resolutions_game_embedding_size_dropdown.png)
...
![../../_images/stretchsettings.png](../../_images/stretchsettings.png)
...
and a diagonal Line2D is added on top of it:

![../../_images/stretch_demo_scene.png](../../_images/stretch_demo_scene.png)
...
![Fractional scaling example (incorrect pixel art appearance)](../../_images/multiple_resolutions_pixel_art_fractional_scaling.png)
...
![Integer scaling example (correct pixel art appearance)](../../_images/multiple_resolutions_pixel_art_integer_scaling.png)
...
- For 3D games, consider exposing Resolution scaling in the game's options menu
...
images in SVG format by changing their import type to DPITexture in
...
offset_transform_visual_only is disabled.
When offset_transform_visual_only is enabled,
...
To resolve this, you can enable mipmaps on
all your 2D textures. However, enabling mipmaps will increase memory usage which
can be an issue on low-end mobile devices.

For SVG images, you can also change their import type to DPITexture in the Import dock
...
resolution scaling functionality. This allows you to
