...
to instance scenes from code, see Nodes and scene instances.
...
objects quickly. See Optimization using MultiMeshes instead.
...
Here's an example of a ball. It's composed of a RigidBody2D node as its root named Ball, which allows the ball to fall
and bounce on walls, a Sprite2D node, and a
CollisionShape2D.

![../../_images/instancing_ball_scene.png](../../_images/instancing_ball_scene.png)
...
![../../_images/instancing_ball_instances_example.png](../../_images/instancing_ball_instances_example.png)
...
![../../_images/instancing_import_button.png](../../_images/instancing_import_button.png)

In the pop-up that appears navigate to the folder you extracted.
Double-click the project.godot file to open it.

![../../_images/instancing_import_project_file.png](../../_images/instancing_import_project_file.png)

Finally, click the Import button.

![../../_images/instancing_import_and_edit_button.png](../../_images/instancing_import_and_edit_button.png)
...
![../../_images/instancing_2d_scene_select.png](../../_images/instancing_2d_scene_select.png)

![../../_images/instancing_main_scene.png](../../_images/instancing_main_scene.png)
...
![../../_images/instancing_scene_link_button.png](../../_images/instancing_scene_link_button.png)

Double-click the ball scene to instance it.

![../../_images/instancing_instance_child_window.png](../../_images/instancing_instance_child_window.png)

The ball appears in the top-left corner of the viewport.

![../../_images/instancing_ball_instanced.png](../../_images/instancing_ball_instanced.png)

Click on it and drag it towards the center of the view.

![../../_images/instancing_ball_moved.png](../../_images/instancing_ball_moved.png)
...
![../../_images/instancing_ball_duplicated.png](../../_images/instancing_ball_duplicated.png)

You can repeat this process until you have several in the scene.

![../../_images/instancing_main_scene_with_balls.png](../../_images/instancing_main_scene_with_balls.png)
...
![../../_images/instancing_ball_scene_open.png](../../_images/instancing_ball_scene_open.png)
...
![../../_images/instancing_physics_material_expand.png](../../_images/instancing_physics_material_expand.png)

Set its Bounce property to 0.5 by clicking on the number field, typing 0.5,
and pressing Enter.

![../../_images/instancing_property_bounce_updated.png](../../_images/instancing_property_bounce_updated.png)
...
![../../_images/instancing_scene_tabs.png](../../_images/instancing_scene_tabs.png)

Select one of the instanced Ball nodes and, in the Inspector, set its
Gravity Scale value to 10.

![../../_images/instancing_property_gravity_scale.png](../../_images/instancing_property_gravity_scale.png)

A grey "revert" button appears next to the adjusted property.

![../../_images/instancing_property_revert_icon.png](../../_images/instancing_property_revert_icon.png)
...
![../../_images/instancing_diagram_shooter.png](../../_images/instancing_diagram_shooter.png)
...
![../../_images/instancing_diagram_open_world.png](../../_images/instancing_diagram_open_world.png)
