...
rollover
setting). It's affected by time_scale but not by pausing.
...
This allows normal maps with RGTC compression to work.
...
bent normal maps with RGTC compression to work.
...
in vec3 LIGHT_COLOR | Light color multiplied by
...
in float SPECULAR_AMOUNT | For OmniLight3D and SpotLight3D,
2.0 multiplied by
light_specular.
For DirectionalLight3D, 1.0.
