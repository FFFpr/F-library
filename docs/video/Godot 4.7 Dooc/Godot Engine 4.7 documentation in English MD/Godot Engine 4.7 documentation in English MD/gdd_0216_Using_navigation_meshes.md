...
![../../_images/nav_meshes.png](../../_images/nav_meshes.png)

2D and 3D versions of the navigation mesh are available as
NavigationPolygon and
...
![Navigation mesh polygon convex vs concave comparison](../../_images/nav_mesh_vs_physics.png)
...
Navigation mesh baking can be done either by using a NavigationRegion2D or NavigationRegion3D, or by using the
NavigationServer2D and NavigationServer3D API directly.

## Baking a navigation mesh with a NavigationRegion

![Navigation mesh baking steps](../../_images/nav_mesh_baking_steps.gif)
...
NavigationMeshSourceGeometryData2D and
NavigationMeshSourceGeometryData3D  respectively.
...
![Building navigation mesh chunks](../../_images/navmesh_chunk_build.gif)
...
![Navigation mesh chunk with bake bound and border size](../../_images/navmesh_bound_bordersize.png)
...
The NavigationPolygon properties baking_rect and baking_rect_offset
can be used to create and place the 2D baking bound.

The NavigationMesh properties filter_baking_aabb and filter_baking_aabb_offset
...
![Navigation mesh chunks with gaps](../../_images/navmesh_chunk_gaps.png)
...
![Navigation mesh chunks without gaps](../../_images/navmesh_chunks.png)
...
![NavigationObstacle3D unwanted geometry discard](../../_images/nav_mesh_obstacles_discard.png)
