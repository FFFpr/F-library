...
vertices. Used in canvas_item shaders and
spatial shaders.
...
each frame. Used in particles shaders.
...
screen. Used in sky shaders.
7. The fog() function runs for every froxel in the volumetric fog froxel
buffer that intersects with the FogVolume. Used by
fog shaders.
...
more information see Using compute shaders.
...
- texture_blit to render DrawableTexture2Ds.
...
data yourself; see the Spatial shader doc for an
example.
