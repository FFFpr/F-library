...
Please report it in the asset store tracker repository [https://github.com/godotengine/godot-asset-store-tracker].

### Is there anywhere I can suggest new features or improvements to the store itself?

Yes! Please open an issue in the asset store tracker repository [https://github.com/godotengine/godot-asset-store-tracker].
...
For now, the Asset Library website [https://godotengine.org/asset-library/asset]
...
Not currently, however that is planned and on the roadmap [https://store.godotengine.org/roadmap/].
