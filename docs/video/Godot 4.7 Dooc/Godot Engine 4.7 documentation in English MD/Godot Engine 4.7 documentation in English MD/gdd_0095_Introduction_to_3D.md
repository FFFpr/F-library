...
![An example 3D game demo created using Godot](../../_images/godot-tps-demo.png)

Godot Third Person Shooter (TPS) Demo, available on the
Github repository [https://github.com/godotengine/tps-demo] or the
Asset Library.
...
![../../_images/tuto_3d3.png](../../_images/tuto_3d3.png)
...
right docks should be familiar from editor introduction.
...
![../../_images/3d_toolbar.png](../../_images/3d_toolbar.png)
...
See Space and manipulation gizmos for more details.
- Rotate Mode (E): Enables rotation mode for the selected nodes. See
Space and manipulation gizmos for more details.
- Scale Mode (R): Enables scaling and displays scaling gizmos in different
axes for the selected nodes. See Space and manipulation gizmos
for more details.
...
rotation angle instead of the global viewport axes.
...
- Use Trackball (U): When enabled, dragging the center of a node (represented by a
subtle ray disc highlight) will rotate the node like a physical trackball.
- Preserve Children Transform (P): When enabled, transforming a node will preserve the
...
Preview environment and light for more details.
...
sunlight and environment settings. See Preview environment and light
for more details.
...
![../../_images/tuto_3d6.png](../../_images/tuto_3d6.png)
...
![../../_images/tuto_3d6_2.png](../../_images/tuto_3d6_2.png)
...
![../../_images/tuto_3d6_1.png](../../_images/tuto_3d6_1.png)
...
![3D coordinate systems comparison chart](../../_images/introduction_to_3d_coordinate_systems.png)
...
![../../_images/tuto_3d5.png](../../_images/tuto_3d5.png)
...
![../../_images/tuto_3d4.png](../../_images/tuto_3d4.png)
...
![../../_images/tuto_3d_gizmo.png](../../_images/tuto_3d_gizmo.png)
...
![../../_images/tuto_3d_updated_view_menu.png](../../_images/tuto_3d_updated_view_menu.png)
...
Following this reasoning, the 3D engine uses the Node3D
node for everything 3D.

![../../_images/tuto_3d1.png](../../_images/tuto_3d1.png)
...
Transform3D, or as 3 Vector3
members representing location, Euler rotation (X, Y and Z angles) and
scale.

![../../_images/tuto_3d2.png](../../_images/tuto_3d2.png)
...
Godot provides a special ImmediateMesh resource
that can be used in a MeshInstance3D node.
...
By default, any 3D scene that doesn't have a WorldEnvironment
node, or a DirectionalLight3D, will have
...
![../../_images/tuto_3d8.png](../../_images/tuto_3d8.png)
...
![../../_images/tuto_3d9.png](../../_images/tuto_3d9.png)
...
displayed unless a Camera3D is
also added to the scene. Cameras can work in either orthogonal or
perspective projections:

![../../_images/tuto_3d10.png](../../_images/tuto_3d10.png)
...
![../../_images/tuto_3d11.png](../../_images/tuto_3d11.png)
...
See 3D lights and shadows for more information on setting up lights in Godot.
