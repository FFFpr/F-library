...
A Viewport's child nodes will render to the image
...
public MyClass()
{
    simultaneousScene = ResourceLoader.Load("res://levels/level2.tscn").Instantiate();
}
...
SceneTree.change_scene_to_file() and
...
CanvasItem.hide() to hide a scene and
CanvasItem.show() to show it again.
...
SubViewportContainers. This is optimal for
