...
For simple gizmos, inheriting EditorNode3DGizmoPlugin
...
Then we can override methods like _redraw()
...
the rest of handle-related callbacks in EditorNode3DGizmoPlugin
...
_create_gizmo(), so it returns our custom gizmo implementation
...
Note that we just added some handles in the _redraw method, but we still need to implement
the rest of handle-related callbacks in EditorNode3DGizmo
to get properly working handles.
