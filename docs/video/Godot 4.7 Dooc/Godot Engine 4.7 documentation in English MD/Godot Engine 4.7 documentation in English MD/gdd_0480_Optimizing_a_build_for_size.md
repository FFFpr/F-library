...
C++ profilers will also no longer be able to display
...
Godot features an Using the engine compilation configuration editor tool that can detect
...
- MenuButton
- OptionButton
- PopupMenu (will make all popup menus unavailable in code for classes that use them,
like LineEdit, even though those classes are still available)
- RichTextEffect
- RichTextLabel
- SpinBox
- SplitContainer
