...
![No 2D lights or shadows, scene is unshaded](../../_images/2d_lights_and_shadows_disabled.png)

No 2D lights or shadows, scene is unshaded

![2D lights enabled (without shadows)](../../_images/2d_lights_and_shadows_enabled_no_shadows.png)

2D lights enabled (without shadows)

![2D lights and shadows enabled](../../_images/2d_lights_and_shadows_enabled.png)
...
CanvasModulate is used to darken the scene by
...
Sprite2Ds are used to display the textures for the light
blobs, the background, and for the shadow casters.

PointLight2Ds are used to light the scene. The way a
light typically works is by adding a selected texture over the rest of the scene
to simulate lighting.

LightOccluder2Ds are used to tell the shader
...
The shadows appear only on areas covered by the PointLight2D and their direction is based on the center of the
Light.
...
![Neutral point light texture](../../_images/2d_lights_and_shadows_neutral_point_light.png)
...
![Hard shadows](../../_images/2d_lights_and_shadows_hard_shadow.png)

Hard shadows

![Soft shadows (PCF13, Filter Smooth 1.5)](../../_images/2d_lights_and_shadows_soft_shadow.png)

Soft shadows (PCF13, Filter Smooth 1.5)

![Soft shadows with streaking artifacts due to Filter Smooth being too high (PCF5, Filter Smooth 4)](../../_images/2d_lights_and_shadows_soft_shadow_streaks.png)
...
them using the free and open source Laigter [https://azagaya.itch.io/laigter]
tool.
...
![Creating a CanvasTexture resource for a Sprite2D node](../../_images/2d_lights_and_shadows_create_canvastexture.png)
