...
![Choosing a draw type for an Empty on creation in Blender](../../../_images/importing_3d_scenes_blender_empty_draw_types.png)
...
See Collision shapes (3D) for a comprehensive overview of collision
shapes.
