...
![ParticleProcessMaterial properties](../../../_images/particle_minmaxcurve1.png)
...
For information on how to use it in a 2D Scene see ParticleProcessMaterial 2D Usage.
...
![Simple particle emission shapes](../../../_images/particle_shapes_simple.png)

Particles emitting from a point (left), in a sphere (middle), and in a box (right)

![Ring-shaped particle system](../../../_images/particle_ring.png)
...
![Different values for particle direction](tutorials/3d/particles/img/particle_direction.png)
...
![Different values for particle spread](tutorials/3d/particles/img/particle_spread.png)
...
![Different values for particle gravity](tutorials/3d/particles/img/particle_gravity.png)
...
![Different values for particle linear acceleration](tutorials/3d/particles/img/particle_accel_linear.png)
...
![Different values for particle radial acceleration](tutorials/3d/particles/img/particle_accel_radial.png)

Negative (left) and positive (right) radial acceleration

## Tangential acceleration

![Tangents on a circle](../../../_images/particle_tangent.png)
...
![Tangential acceleration from above](tutorials/3d/particles/img/particle_accel_tangent.png)
...
![Particle color ramp](../../../_images/particle_ramp.png)
...
![Different values for hue variation](../../../_images/particle_hue.png)
...
![A sprite sheet](../../../_images/particle_sprite.png)
...
![Animated particles](tutorials/3d/particles/img/particle_animate.png)
...
![Animated particles lifetimes](tutorials/3d/particles/img/particle_animate_lifetime.png)
...
You can learn more about particle collisions in the Collisions
section in this manual.

# Sub-emitter

![Sub-emitter modes](../../../_images/particle_sub_mode.png)
