...
![../../_images/2d_platformer_demo.png](../../_images/2d_platformer_demo.png)
...
![../../_images/2d_editor_viewport.png](../../_images/2d_editor_viewport.png)
...
be familiar from editor introduction.
...
![../../_images/2d_toolbar.png](../../_images/2d_toolbar.png)
...
axes for the selected node(s). See 2D Viewport for more details.
...
exceptions. For example, the default pivot for a Sprite2D is its
...
![../../_images/2d_ruler_with_snap.png](../../_images/2d_ruler_with_snap.png)
...
![../../_images/2d_snapping_options_menu.png](../../_images/2d_snapping_options_menu.png)
...
![../../_images/2d_snapping_options.png](../../_images/2d_snapping_options.png)
...
depend heavily on the viewport, it is covered in the 2D Viewport
section.
...
![../../_images/2d_editor_viewport_with_viewmenu.png](../../_images/2d_editor_viewport_with_viewmenu.png)
...
![../../_images/2d_editor_guidelines.png](../../_images/2d_editor_guidelines.png)
...
2D Viewport more on rulers.
- Show Guides: Toggles the visibility of created guides. See
2D Viewport for on how to create them.
...
CanvasItem is the base node for 2D. Node2D is the base node
for 2D game objects, and Control is the base node
for everything GUI. For 3D, Godot uses the Node3D node.

## Displaying 3D nodes in 2D

It is possible to display 3D nodes in a 2D scene by using a SubViewport. You can see this in the demo 3D in 2D Viewport [https://godotengine.org/asset-library/asset/2804].

![../../_images/3d_in_2d_demo_editor.png](../../_images/3d_in_2d_demo_editor.png)
